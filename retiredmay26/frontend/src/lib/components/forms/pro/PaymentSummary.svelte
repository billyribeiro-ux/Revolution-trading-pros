...
>
	...
	>
		<Icon name="IconShoppingCart" size={20} class="text-gray-700 flex-shrink-0" />
		...
		{#if discount}
			<div class="flex justify-between items-center py-1 sm:py-1.5 min-h-[36px] sm:min-h-[40px]">
				<span class="flex items-center gap-1.5 sm:gap-2 text-sm sm:text-base text-emerald-600">
					<Icon name="IconGift" size={14} class="flex-shrink-0" />
	...
	{#if discount}
		...
		>
			<Icon name="IconCheck" size={16} class="flex-shrink-0" />
