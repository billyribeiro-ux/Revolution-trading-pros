...
$status = ConsentMagic()->getOption( 'wc_am_client_consent_magic_pro_activated' );
?>

<div class="card card-static card-style9 license license-woo">
        ...
        <div class="gap-22">
            ...
            <div>
                <h4 class="font-semibold-type2 mb-2">
					<?php esc_html_e( 'Your Product ID:', 'consent-magic' ); ?>
                </h4>
				...
				<?php if ( $status == 'Activated' || $status == 'Expired' ) : ?>
                    <div class="cm-license-key license-activated">
