...
namespace ConsentMagicPro\GuzzleHttp;

use ConsentMagicPro\GuzzleHttp\Cookie\CookieJar;
use ConsentMagicPro\GuzzleHttp\Exception\GuzzleException;
use ConsentMagicPro\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \ConsentMagicPro\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
