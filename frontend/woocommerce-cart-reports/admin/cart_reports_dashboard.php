...
class AV8_Cart_Dashboard {
	...
	public function woocommerce_recent_cart_activity_legacy() {
		...
		<div class="table table_carts_right_now">
			<p class="sub woocommerce_sub"><?php esc_html_e( 'Right Now', 'woocommerce_cart_reports' ); ?></p>
			<table>
				<tr class="first">
					...
					<td class="b b-open"><?php echo wp_kses_post( $num ); ?></td>
					<td class="last t open"><?php echo wp_kses_post( $text ); ?></td>
				</tr>
		...
		<div class="table table_carts">
			<p class="sub woocommerce_sub">
				...
				echo esc_html( sprintf( __( 'The Last %s Day%s', 'woocommerce_cart_reports' ), $days, $plural ) );
				?>
			</p>
			<table>
				<tr class="first">
					...
					<td class="b b-abandoned"><?php echo wp_kses_post( $num ); ?></td>
					<td class="last t abandoned"><?php echo wp_kses_post( $text ); ?></td>
				</tr>
				<tr>
					<?php
					...
					<td class="b b-converted"><?php echo wp_kses_post( $num ); ?></td>
					<td class="last t converted"><?php echo wp_kses_post( $text ); ?></td>
				</tr>
			</table>
		</div>
		<div class="table table_carts_life">
			<p class="sub woocommerce_sub"><?php esc_html_e( 'Lifetime', 'woocommerce_cart_reports' ); ?></p>
			<table>
				<tr class="first">
