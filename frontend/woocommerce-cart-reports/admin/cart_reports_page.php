...
function cart_reports_by_date() {
	include_once __DIR__ . '/reports/class-wc-report-carts-by-date.php';
	$report = new WC_Report_Carts_By_Date();
	$report->output_report();
}

function cart_reports_by_product() {
	include_once __DIR__ . '/reports/class-wc-report-carts-by-product.php';
	$report = new WC_Report_Carts_By_Product();
	$report->output_report();
}
