    ...
    <div class="container-fluid">
        <ul>
            ...
            <li class="item-cat item-custom-post-type-indicators">
                <a class="breadcrumb-cat breadcrumb-custom-post-type-indicators" href="" title="Indicators">Indicators</a>
            </li>
            <li class="separator"> / </li>
            <li class="item-current item-719939">
                <strong class="breadcrumb-current breadcrumb-719939" title="Volume Max Tool Kit (formerly VWAP)">Volume Max Tool Kit (formerly VWAP)</strong>
            </li>
        </ul>
    </div>
</nav>
...
<div class="st_box thinkorswim">
    <img width="250" src="/wp-content/themes/simpler-trading/assets/images/thinkorswim.png" alt="ThinkorSwim">
...
<div class="st_box tradingview">
    <img width="250" src="/wp-content/themes/simpler-trading/assets/images/tradingview.png" alt="TradingView">
                    ...
                    <div class="fl-col fl-node-5d56ce96c4b9d">
                        <div class="fl-col-content fl-node-content">
                            ...
                            <div class="fl-module fl-module-rich-text fl-node-5d56ce96c4c1b">
                                <div class="fl-module-content fl-node-content">
                                    <div class="fl-rich-text">
                                        <p>Our support staff is the best by far! You can email 
                                           <a href="mailto:support@simplertrading.com">support@simplertrading.com</a> 
                                           or call us at <a href="tel:5122668659">(512) 266-8659</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div id="content" class="site-content">
            <div class="indicators">
                <main>
                    ...
                    <section>
                        <p class="platforms"><strong>Available Platforms:</strong> ThinkorSwim, TradingView</p>
                        <hr>
