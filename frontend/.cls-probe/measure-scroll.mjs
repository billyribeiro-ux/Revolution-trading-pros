...
const init = () => {
	...
	new PerformanceObserver((l) => {
		for (const e of l.getEntries()) {
			...
			window.__s.push({ v: +e.value.toFixed(4), src });
		}
	...
	JSON.stringify(
		{
			...
			shiftCount: r.s.length,
			topSources: Object.entries(agg)
				.sort((a, b2) => b2[1] - a[1])
				.slice(0, 6)
				.map(([n, v]) => ({ node: n, cls: +v.toFixed(4) }))
		},
		null,
		2
	)
