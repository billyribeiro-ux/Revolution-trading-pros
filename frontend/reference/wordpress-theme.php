...
.membership-cards .membership-card__header:hover span.mbrship-card_icn {
...
.sec-relat-post .uael-post__inner-wrap,
.sec-relat-post2 .uael-post__inner-wrap {
    display: -webkit-flex;
    display: -ms-flexbox;
    display: flex;
...
.uael-posts-thumbnail-ratio.sec-relat-post .uael-post__bg-wrap,
.uael-posts-thumbnail-ratio.sec-relat-post2 .uael-post__bg-wrap {
    overflow: unset;
}
...
.uael-posts-thumbnail-ratio.sec-relat-post .uael-post__thumbnail img,
...
.woocommerce-account.woocommerce-page #loading {
    ...
    width: 100%;
    height: 100vh;
    background: #343436 url("img/elite-trading-llive-preloader.png") no-repeat center center;
    z-index: 100012;
    padding-top: 3%;
    text-align: center;
}
...
button.dashboard__toggle-button,
button.dashboard__toggle-button {
    border: none;
    outline: none;
}

button.dashboard__toggle-button:focus,
button.dashboard__toggle-button:hover {
...
@media screen and (max-width: 980px) {
    ...
    .html--dashboard-menu-open .woocommerce-account nav.woocommerce-MyAccount-navigation,
    .html--dashboard-menu-open nav.woocommerce-MyAccount-navigation .account-secondry-menu {
        opacity: 1;
        visibility: visible;
...
.package-2 .pricing-badge img {
    filter: invert(49%) sepia(100%) saturate(527%) hue-rotate(178deg) brightness(98%) contrast(102%);
}
...
/* payment method */
/* 1st */
div#root .p-LTR.p-Locale-en .p-HeightObserverProvider .p-FadeWrapper .p-PaymentDetails-group form .p-Grid.p-CardForm>.p-GridCell.p-GridCell--12.p-GridCell--md6 {
...
div#root .p-LTR.p-Locale-en .p-HeightObserverProvider .p-FadeWrapper .p-PaymentDetails-group form .p-Grid.p-CardForm>.p-GridCell.p-GridCell--12.p-GridCell--md6>.p-Field {
    width: 100%;
    display: inline-block;
    clear: none;
...
/* 2nd */
div#root .p-LTR.p-Locale-en .p-HeightObserverProvider .p-FadeWrapper .p-PaymentDetails-group form .p-Grid.p-CardForm>.p-GridCell.p-GridCell--12.p-GridCell--xs6.p-GridCell--sm6.p-GridCell--md3 {
    width: 30%;
    display: inline-block;
}

div#root .p-LTR.p-Locale-en .p-HeightObserverProvider .p-FadeWrapper .p-PaymentDetails-group form .p-Grid.p-CardForm>.p-GridCell.p-GridCell--12.p-GridCell--xs6.p-GridCell--sm6.p-GridCell--md3 .p-Field[data-field|="expiry"] {
    width: 100%;
    display: inline-block;
    clear: none;
    /*   border:2px solid red; */
...
/* 3rd */
div#root .p-LTR.p-Locale-en .p-HeightObserverProvider .p-FadeWrapper .p-PaymentDetails-group form .p-Grid.p-CardForm>.p-GridCell.p-GridCell--12.p-GridCell--xs6.p-GridCell--sm6.p-GridCell--md3 .p-Field[data-field|="cvc"] {
    width: 160%;
    display: inline-block;
    clear: none;
...
/* 1st,2nd,3rd input */
div#root .p-LTR.p-Locale-en .p-HeightObserverProvider .p-FadeWrapper .p-PaymentDetails-group form .p-Grid.p-CardForm>.p-GridCell.p-GridCell--12.p-GridCell--md6>.p-Field div .p-CardNumberInput .p-Input input,
div#root .p-LTR.p-Locale-en .p-HeightObserverProvider .p-FadeWrapper .p-PaymentDetails-group form .p-Grid.p-CardForm>.p-GridCell.p-GridCell--12.p-GridCell--xs6.p-GridCell--sm6.p-GridCell--md3>.p-Field div .p-Input input {
    padding: 12px 8px;
    border-color: #c7c1c6;
...
div#root .p-LTR.p-Locale-en .p-HeightObserverProvider .p-FadeWrapper .p-PaymentDetails-group form .p-Grid.p-CardForm>.p-GridCell.p-GridCell--12.p-GridCell--xs6.p-GridCell--sm6.p-GridCell--md3:has(.p-Field[data-field="expiry"]) {
    float: right !important;
}

div#root .p-LTR.p-Locale-en .p-HeightObserverProvider .p-FadeWrapper .p-PaymentDetails-group form .p-Grid.p-CardForm>.p-GridCell.p-GridCell--12.p-GridCell--md6:has(.p-Field[data-field="number"]) {
    width: 68%;
}

.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.form-row>.bar {
    width: 100%;
    /* height: 1px; */
    border-bottom: 1px solid #dbdbdb;
    position: absolute;
...
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods+.form-row.place-order>button#wpmc-prev {
    color: #0984ae;
    font-size: 17px;
    line-height: 24px;
    padding: 12px 34px;
...
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods+.form-row.place-order>button#wpmc-prev:hover {
    color: #0984ae !Important;
    background: #e7e7e7 !important;
    border-color: transparent;
}

.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods+.form-row.place-order>button#place_order {
    width: 146px;
    font-size: 17px;
    line-height: 24px;
    padding: 12px 24px;
...
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods+.form-row.place-order>button#place_order:hover {
    background: #f88b09;
    border-color: #f88b09;
}


.page-id-194.elementor-page-194 .wpmc-steps-wrapper>form.checkout.woocommerce-checkout>.wpmc-step-item.wpmc-step-billing.current>.woocommerce-billing-fields .clear {
    width: 100%;
    /* height: 1px; */
    border-bottom: 1px solid #dbdbdb;
    position: absolute;
...
.page-id-193.elementor-page-193 form.woocommerce-cart-form>table.shop_table.shop_table_responsive.cart.woocommerce-cart-form__contents>tbody>tr {
    background-color: var(--bgColorRow);

}

.page-id-193.elementor-page-193 form.woocommerce-cart-form>table tbody tr:hover>td,
...
.page-id-193.elementor-page-193 form.woocommerce-cart-form>table.shop_table.shop_table_responsive.cart.woocommerce-cart-form__contents>tbody>tr>td {
    border: none !important;
    font-family: var(--fontFamily) !important;
    color: var(--textColor) !important;
}

.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form>table>tbody>tr>.product-thumbnail>a>.size-woocommerce_thumbnail {
    width: 100% !important;
...
.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form>table>tbody>tr>.product-thumbnail>a {
...
.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form>table>tbody>tr>.product-thumbnail {
    width: 162px !important;
    height: 110px !important;

}

.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form>table>tbody>tr>.product-price>.woocommerce-Price-amount>bdi {
    font-size: 19px;
    line-height: 1.15;
    font-weight: 700;
    color: var(--textColor) !important;
...
.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form>table>tbody>tr>.product-price>span.woocommerce-Price-amount.amount~del,
.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form>table>tbody>tr>.product-price>span.woocommerce-Price-amount.amount+del {
    position: relative;
    bottom: 25px;
    left: 80px;
...
.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form>table>tbody>tr>.product-price {
    width: 190.36px !important;
    height: 126px !important;
    padding: 20px !important;
}

.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form>table>tbody>tr>.product-price>span.woocommerce-Price-amount.amount {
    display: flex;
    position: relative;
    bottom: 15px;
}

.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form>table>tbody>tr>.product-price>a.remove_product {
    font-size: 14px;
    line-height: 18px;
...
/*making inline*/
.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce {
    display: inline;
}

.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form.woocommerce-cart-form {
    width: 60%;
    display: inline-block;
}

.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce .cart-collaterals,
...
.page-id-193.elementor-page-193 .cart-collaterals>.cart_total>.order-total>h2>strong>.woocommerce-Price-amount>bdi {
...
.page-id-193.elementor-page-193.woocommerce-cart .wc-proceed-to-checkout a.checkout-button {
    font-size: 17px !important;
...
.page-id-193.elementor-page-193 .elementor-shortcode>.woocommerce .cart-collaterals .cart_totals,
.woocommerce-page .cart-collaterals .cart_totals {
    width: 55% !important;
}

.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>h3 {
    display: block;
}

.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>small {
    display: block;
    position: absolute;
}
...
.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form>table>tbody>tr.blank {
    height: 15px;
}
...
.page-id-193.elementor-page-193 form.woocommerce-cart-form>table.shop_table.shop_table_responsive.cart.woocommerce-cart-form__contents>tbody>tr:hover {
    -webkit-box-shadow: 0 5px 20px rgba(0, 0, 0, .1);
    box-shadow: 0 5px 20px rgba(0, 0, 0, .1)
}
...
.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce .cart-collaterals:hover {
    -webkit-box-shadow: 0 5px 20px rgba(0, 0, 0, .1);
    box-shadow: 0 5px 20px rgba(0, 0, 0, .1)
}
...
.page-id-193.elementor-page-193.woocommerce-page .cart-collaterals .cart_totals>h2>strong {
    font-size: 42px;
    line-height: 44px;
    font-weight: 700 !important;
    color: rgb(65, 65, 65);
...
/*button width manage:*/
.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form>table>tbody>tr>.product-price>a.remove_product:hover {
    background: #e7e7e7 !important;
...
.page-id-193.elementor-page-193.woocommerce-cart .wc-proceed-to-checkout a.checkout-button:hover {
    color: #FFFFFF !important;
    background-color: #ff9400 !important;
}

/*display none to extra tr:*/
.page-id-193.elementor-page-193.woocommerce-page .cart-collaterals .cart_totals>.shop_table_responsive {
    display: none;
}
...
.page-id-193.elementor-page-193.woocommerce-cart .wc-proceed-to-checkout+.tax-disclaimer {
...
.page-id-193.elementor-page-193.woocommerce-cart .wc-proceed-to-checkout+.tax-disclaimer+hr {
    display: none;
}
...
.page-id-193.elementor-page-193 form.woocommerce-cart-form>table.shop_table.shop_table_responsive.cart.woocommerce-cart-form__contents>tbody>tr>td:first-child {
...
.page-id-193.elementor-page-193 form.woocommerce-cart-form>table.shop_table.shop_table_responsive.cart.woocommerce-cart-form__contents>tbody>tr>td:last-child {
...
.page-id-193.elementor-page-193 form.woocommerce-cart-form>table.shop_table.shop_table_responsive.cart.woocommerce-cart-form__contents>tbody>tr>.product-thumbnail,
.page-id-193.elementor-page-193 form.woocommerce-cart-form>table.shop_table.shop_table_responsive.cart.woocommerce-cart-form__contents>tbody>tr>.product-name,
.page-id-193.elementor-page-193 form.woocommerce-cart-form>table.shop_table.shop_table_responsive.cart.woocommerce-cart-form__contents>tbody>tr>.product-price {
...
@import url('https://fonts.googleapis.com/css2?family=Lobster&family=Open+Sans:wght@300&family=Press+Start+2P&display=swap');
...
.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>small::before {
    content: "(";
}

.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>small::after {
    content: ")";
}

.page-id-193.elementor-page-193 .elementor-element-afd65d2>.elementor-widget-wrap {
    padding: 0px !important;
...
.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form>table>tbody>tr>.product-thumbnail>a>.size-woocommerce_thumbnail>img {
    width: 100% !important;
    height: 100% !important;
    border-radius: 5px;
}

.page-id-193 section.elementor-element.elementor-element-32c3ef4d.elementor-section-boxed.elementor-section-height-default.elementor-top-section {

    display: none;

}

.page-id-193.elementor-page-193.woocommerce-cart .wc-proceed-to-checkout~.coupon_add>.coupon>#coupon_code {
    height: 40px;
    font-size: 14px;
    line-height: 38px;
    padding: 0 12px;
...
.page-id-193.elementor-page-193.woocommerce-cart .wc-proceed-to-checkout~.coupon_add>.coupon>#coupon_code:focus {
    border-color: #1e73be;
}

.page-id-193.elementor-page-193.woocommerce-cart .wc-proceed-to-checkout~.coupon_add>.coupon>#coupon_code:hover {
    border-color: #7e7d7e
}

.page-id-193.elementor-page-193.woocommerce-cart .wc-proceed-to-checkout~.coupon_add>.coupon>.button {
    /* font-size: 17px !important; */
    line-height: 22px;
    padding: 8px 12px;
    background: #f99e31 !important;
...
.page-id-193.elementor-page-193.woocommerce-cart .wc-proceed-to-checkout~.coupon_add>.coupon>,
button:focus {
    background: #076787;
    border-color: #076787;
    color: #FFFFFF;
...
.page-id-193.elementor-page-193.woocommerce-cart .wc-proceed-to-checkout~.coupon_add>.coupon>.button:hover {
    background: #076787;
    border-color: #076787;
    color: #FFFFFF;
    background-color: #ff9400 !important;
...
.page-id-193.elementor-page-193.woocommerce-cart .wc-proceed-to-checkout a.checkout-button:focus {
    background: #076787;
...
.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form.woocommerce-cart-form>button.clear_cart_button {
    font-family: "sofia-pro", Sans-serif;
    font-size: 20px;
    font-weight: 400;
    color: #FFFFFF;
...
.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form.woocommerce-cart-form>button.clear_cart_button:hover {
    background: #076787;
    /*     border-color: #076787; */
    color: #FFFFFF;
    background-color: #ff9400 !important;
...
.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form.woocommerce-cart-form>button.clear_cart_button:focus {
    background: #076787;
    border-color: #076787 !important;
    color: #FFFFFF;
    background-color: #ff9400 !important;
...
.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form>table.shop_table.woocommerce-cart-form__contents {
    margin: 0px -1px 0px 0 !important;
}

.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form> {
    margin-bottom: 50px;
}
...
.page-id-194.elementor-page-194 .wpmc-steps-wrapper>form.checkout.woocommerce-checkout>.wpmc-step-item.wpmc-step-billing.current>.woocommerce-billing-fields {
...
.page-id-194.elementor-page-194 .wpmc-steps-wrapper>form.checkout.woocommerce-checkout>.wpmc-step-item.wpmc-step-billing.current>.woocommerce-billing-fields:hover {
    -webkit-box-shadow: 0 5px 20px rgba(0, 0, 0, .1);
    box-shadow: 0 5px 20px rgba(0, 0, 0, .1)
}

.page-id-194.elementor-page-194 .wpmc-steps-wrapper>form.checkout.woocommerce-checkout>.wpmc-step-item.wpmc-step-billing.current>.woocommerce-billing-fields P.form-row {
...
.page-id-194.elementor-page-194 .wpmc-steps-wrapper>form.checkout.woocommerce-checkout>.wpmc-step-item.wpmc-step-billing.current>.woocommerce-billing-fields P.form-row>span>input:focus {
    border-color: #1e73be !important;

}

.page-id-194.elementor-page-194 .wpmc-steps-wrapper>form.checkout.woocommerce-checkout>.wpmc-step-item.wpmc-step-billing.current>.woocommerce-billing-fields P.form-row>span>input:hover {

    border-color: #7e7d7e !important;
}

.page-id-194.elementor-page-194 .wpmc-steps-wrapper>form.checkout.woocommerce-checkout>.wpmc-step-item.wpmc-step-billing.current>.woocommerce-billing-fields P.form-row>span>input {
    border-radius: 5px !important;
    box-sizing: border-box;
    width: 100%;
    margin: 0;
...
.page-id-194.elementor-page-194 .wpmc-steps-wrapper>form.checkout.woocommerce-checkout>.wpmc-step-item.wpmc-step-billing.current>.woocommerce-billing-fields P.form-row>span>label {
...
.page-id-194.elementor-page-194 .wpmc-steps-wrapper>form.checkout.woocommerce-checkout>.wpmc-step-item.wpmc-step-billing.current>.woocommerce-billing-fields .form-row>label:not(.required) {
    color: #7e7d7e !important;
    font-weight: 700;
    margin-bottom: 8px;
    line-height: 2;
...
.page-id-194.elementor-page-194 .wpmc-steps-wrapper>form.checkout.woocommerce-checkout>.wpmc-step-item.wpmc-step-billing.current>.woocommerce-billing-fields .form-row>label>.required {
...
.page-id-194.elementor-page-194 .wpmc-steps-wrapper>form.checkout.woocommerce-checkout>.wpmc-step-item.wpmc-step-billing.current>.woocommerce-billing-fields>h3 {
    font-size: 22px;
    /* margin-bottom: 30px; */
    font-weight: 500;
    line-height: 1.2;
...
.page-id-194.elementor-page-194 .wpmc-steps-wrapper>form.checkout.woocommerce-checkout>.wpmc-step-item.wpmc-step-billing.current>.woocommerce-billing-fields>#wpmc-back-to-cart {
    color: #0984ae;
    font-size: 17px;
    line-height: 24px;
    padding: 12px 44px;
...
.page-id-194.elementor-page-194 .wpmc-steps-wrapper>form.checkout.woocommerce-checkout>.wpmc-step-item.wpmc-step-billing.current>.woocommerce-billing-fields>#wpmc-back-to-cart:hover {
    color: #0984ae;
    background: #e7e7e7;
    border-color: transparent
}
...
.page-id-194.elementor-page-194 .wpmc-steps-wrapper>form.checkout.woocommerce-checkout>.wpmc-step-item.wpmc-step-billing.current>.woocommerce-billing-fields>#nect {
...
.page-id-194.elementor-page-194 .wpmc-steps-wrapper>form.checkout.woocommerce-checkout>.wpmc-step-item.wpmc-step-billing.current>.woocommerce-billing-fields>#nect:hover {
    background: #f88b09;
    border-color: #f88b09
}
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce>.wpmc-tabs-wrapper {
    width: 770px;
    float: left;
    position: relative;
    /* border: 2px solid red; */
...
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods {
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce>.wpmc-tabs-wrapper .wpmc-tab-item:before {
    display: block;
    content: "";
...
/* start side div */
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper {
    /*border:2px solid red;*/
    display: flex;
    flex-direction: column;
    width: 325px;
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper:hover {
    -webkit-box-shadow: 0 5px 20px rgba(0, 0, 0, .1);
    box-shadow: 0 5px 20px rgba(0, 0, 0, .1)
}

.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper .main_div_cart {
    /*border:2px solid red;*/
    display: flex;
    justify-content: space-between;
    align-items: center;
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper .main_div_cart>h3 {
    font-weight: 700 !important;
    font-size: 1.5rem;
    line-height: 1.2;
    color: #414141f5;
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper .main_div_cart>a {
    font-size: 14px;
    line-height: 18px;
    padding: 8px 14px;
    font-weight: 600;
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper .main_div_cart>a:hover {
    background: #e7e7e7 !important;
}

.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper .tax_class {
    margin: 0 auto;
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper .tax_class>.tx_text {
    width: 50%;
    height: 100%;
    /* 	border:2px solid red; */
    margin: 0 auto;
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper .tax_class>.tx_amount {
    width: 50%;
    height: 100%;
    /* 	border:2px solid red; */
    margin: 0 auto;
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper .total_checkout_amount {
    margin: 0 auto;
    width: 100%;
    height: 100%;
    /* 	border:2px solid red; */
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper .total_checkout_amount>.total_am {
    font-size: 20px;
    line-height: 32px;
    margin: 0;
}

.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper .total_checkout_amount>.checkout_cart_total {
    font-weight: 700;
    margin: 0;
}

/*24-june*/
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper .total_checkout_amount>.total_am>strong {
    color: #414141;
    font-size: 26px;
    line-height: 32px;
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper>br {
    display: none;
}

.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper>.shop_table_responsive {
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper>.shop_table_responsive>tbody>tr>td {
    background: var(--bgColorRow) !important;
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce>.wpmc-nav-wrapper>table>tbody>tr>.product-thumbnail>.size-woocommerce_thumbnail>img {
    width: 52px;
    height: 52px;
    border-radius: 5px;
    box-sizing: border-box;
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper>.shop_table_responsive>tbody>tr>.product-price {
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper>.shop_table_responsive>tbody>tr>.product-name {
    /* 	border:2px solid red !important; */
    /* 	display:flex; */
    padding: 0px !Important;
    padding-top: 10px !important;
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper>.shop_table_responsive>tbody>tr>.product-name::after {
    content: "";
}

.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper>.shop_table_responsive>tbody>tr>.product-price>span>bdi {
    position: relative;
    padding-right: 15px !important;
    padding-left: 5px;
    font-weight: 700;
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper>.shop_table_responsive>tbody>tr>.product-thumbnail {
    /* 	border:2px solid red !important; */
    /* 	flex-grow:1; */
    /*padding-right:15px;*/
    /*padding-left:15px;*/
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-steps-wrapper {
    float: left;
}
...
.page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form>table>tbody>tr>.product-thumbnail>.size-woocommerce_thumbnail>img {
    width: 100% !important;
    height: 100% !important;
    border-radius: 5px;
}
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-tabs-wrapper .wpmc-tabs-list {
    margin-top: 50px;
}


.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-tabs-wrapper .wpmc-tab-item .wpmc-tab-text {
...
.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-tabs-wrapper .wpmc-tab-item {
    padding-bottom: 0px !important;
}

.page-id-194.elementor-page-194 .wpmc-steps-wrapper>form.checkout.woocommerce-checkout>.wpmc-step-item.wpmc-step-billing.current>.wc_coupon_message_wrap {
    padding: 0px !important;
...
.page-id-193.elementor-page-193.woocommerce-cart .coupon>#coupon_code:hover {
    border-color: #7e7d7e
}

.page-id-193.elementor-page-193.woocommerce-cart .coupon>#coupon_code:focus {
    border-color: #1e73be;
}
...
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment {
    background: #fff !important;
    padding: 10px 30px;
}

.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods>li .payment_box.payment_method_woocommerce_payments {
    /*  border: 2px solid blue; */
    background: transparent !Important;

}

.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods>li .payment_box.payment_method_woocommerce_payments fieldset#wc-woocommerce_payments-upe-form {
    /* 	border: 2px solid blue; */
    background: transparent !Important;
    padding: 0px;
    border: none;
...
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods>.wc_payment_method>input#payment_method_woocommerce_payments,
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods>.wc_payment_method>input#payment_method_woocommerce_payments+label {
...
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods>li.wc_payment_method.payment_method_bacs>input#payment_method_bacs,
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods>li.wc_payment_method.payment_method_cheque>input#payment_method_cheque,
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods>.wc_payment_method>input#payment_method_woocommerce_payments,
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods>.wc_payment_method>input#payment_method_woocommerce_payments {
...
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods>li.wc_payment_method.payment_method_bacs {
    /* border:2px solid red; */
    padding-left: 30px;
}

.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods>li.wc_payment_method.payment_method_cheque {
    padding-left: 30px;
    /*padding-bottom:20px;*/
}
...
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods>li.wc_payment_method.payment_method_bacs>input#payment_method_bacs:checked,
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods>li.wc_payment_method.payment_method_cheque>input#payment_method_cheque:checked {
    background: white;
...
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods>.wc_payment_method>input#payment_method_woocommerce_payments:checked {
    background: white;
    /*     border: px solid black; */
    /*     outline-offset: 5px; */
    width: 12px !important;
...
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods>.wc_payment_method>div>fieldset>div>p>input#wc-woocommerce_payments-new-payment-method {
    width: 20px !important;
    height: 20px;
    position: relative;
    right: 2px;
...
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods>.wc_payment_method>div>fieldset>div>p>label {
    position: relative;
    right: 7px;
}
...
.page-id-194.elementor-page-194 .wpmc-step-payment>.woocommerce-checkout-payment>.wc_payment_methods>li.wc_payment_method.payment_method_cheque>input#payment_method_cheque+label {
    /* 	color:red; */
    position: relative;
    /*left:5px;*/
    /*bottom:3px;*/
...
.page-id-193.elementor-page-193 form.woocommerce-cart-form>table.shop_table.shop_table_responsive.cart.woocommerce-cart-form__contents>tbody>tr>.product-name:hover {
...
/* START LOGIN */
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login>p>label>span.required {
    color: #d9534f !important;
    font-size: 20px;
}

.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login {
    /*border: 2px solid red !important;*/
    display: flex;
    width: 756px;
    /*height: 475px;*/
...
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login:hover {
    -webkit-box-shadow: 0 5px 20px rgba(0, 0, 0, .1) !important;
    box-shadow: 0 5px 20px rgba(0, 0, 0, .1) !important;
}

.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>.site-content {
    /*border:2px solid red;*/
    width: 50%;
    height: auto;
    display: flex;
...
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login {
    border: none !important;
    background: transparent !important;
    border-radius: 0px !important;
    -webkit-box-shadow: none !important;
...
/*.page-id-194.elementor-page-194  .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login:hover{
	pointer-events: none;
}*/

.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login>p.form-row.form-row-last,
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login>p.form-row.form-row-first {
    /* 	width:100%; */
    display: block;
    width: 100%;
    /*    height: 50px;  */
...
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login>p.form-row.form-row-first>label,
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login>p.form-row.form-row-last>label {
    color: #7e7d7e !important;
    font-weight: 700 !important;
    margin-bottom: 8px !important;
}

.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login>p.form-row.form-row-first>.input-text {
    display: block;
    width: 100%;
    height: 50px;
    padding: 0 16px;
...
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login>p.form-row.form-row-last>.password-input {
    display: block;
    position: static !important;
}

.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login>p.form-row.form-row-last>.password-input>input#password {
...
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login>p.form-row.form-row-first>.input-text:hover {

    border-color: #7e7d7e !important;
}

.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login>p.form-row.form-row-first>.input-text:focus {
    border-color: #1e73be !important;
}

.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login>p.form-row.form-row-last>.password-input>input#password:focus {
    border-color: #1e73be !important;
}

.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login>p.form-row.form-row-last>.password-input>input#password:hover {
    border-color: #7e7d7e !important;
}

.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>.site-content>h2.new_heading {
    font-size: 22px;
    margin-bottom: 30px;
    font-weight: 500;
    line-height: 1.2;
...
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>.site-content>h2.new_heading:after {
    display: block;
    content: "";
    width: 130px;
    height: 1px;
...
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>.site-content>h2.new_heading+div+p {
    margin-top: 0;
    margin-bottom: 1rem;
    font-family: "Open Sans", sans-serif;
    color: rgb(65, 65, 65);
...
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>.site-content>h2.new_heading+div+p+a {
    font-size: 17px;
    line-height: 24px;
    padding: 12px 27px;
    background: #f99e31;
...
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>.site-content>h2.new_heading+div+p+a:hover {
    background: #f88b09;
    border-color: #f88b09;
}

.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login button.woocommerce-button.button.woocommerce-form-login__submit {
    width: 110px;
    height: 48px;
    font-family: "sofia-pro", Sans-serif;
    font-size: 20px;
...
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login button.woocommerce-button.button.woocommerce-form-login__submit:hover {
    background: #f88b09;
    border-color: #f88b09;
}

.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login .lost_password {
    font-size: 14px !important;
    text-align: center;
    /*margin-top:10px;*/
}

.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login .lost_password>a {
    color: #1e73be;
    font-weight: 400;
    text-decoration: none;
    transition: color .1s ease-in-out, background-color .1s ease-in-out;
...
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login .form-row input#rememberme {
    width: 20px !important;
    height: 20px !important;
    border-radius: 3px;
...
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login .form-row input#rememberme:checked:after {
    color: white;
    font-family: FontAwesome;
    content: "\F00C";
    display: flex;
    ...
    /*     border-radius: 3px; */
    overflow: hidden;
    -webkit-transition: all .3s cubic-bezier(.48, -.6, .48, 1.65), padding .3s cubic-bezier(.48, -.6, .48, 1.65) .04s;
    -o-transition: all .3s cubic-bezier(.48, -.6, .48, 1.65), padding .3s cubic-bezier(.48, -.6, .48, 1.65) .04s;
    transition: all .3s cubic-bezier(.48, -.6, .48, 1.65), padding .3s cubic-bezier(.48, -.6, .48, 1.65) .04s;

}

.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login .form-row input#rememberme:checked {
    border-color: #0984ae;
    background: #0984ae;
}

.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login .form-row input#rememberme+span {
    color: #7e7d7e;
    font-weight: 400;
    margin-left: 8px;
    position: relative;
...
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login .form-row label.woocommerce-form-login__rememberme {
    margin-bottom: 16px;
}

.page-id-194.elementor-page-194 .elementor-element-00ff6e8>.elementor-widget-container>.elementor-shortcode>.woocommerce .wpmc-nav-wrapper>.shop_table_responsive>tbody>tr>.product-price>del {
    font-size: 12px;
    padding-right: 8px;
}

.page-id-193.elementor-page-193 .elementor-shortcode>.woocommerce .cart-collaterals .cart_totals>P>span.applie_coupon,
.page-id-193.elementor-page-193 .elementor-shortcode>.woocommerce .cart-collaterals .cart_totals>P>.dis {
    font-weight: 600;
    color: rgb(65, 65, 65);
}

.page-id-193.elementor-page-193 .elementor-shortcode>.woocommerce .cart-collaterals .cart_totals>P>span.applie_code,
.page-id-193.elementor-page-193 .elementor-shortcode>.woocommerce .cart-collaterals .cart_totals>P>span.applie_price {
    color: rgb(102, 102, 102);
    font-size: 14px;
    padding-left: 10px;
}

.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form.woocommerce-form-login>p {
    color: rgb(65, 65, 65);
    font-size: 22px;
    font-family: "Open Sans", sans-serif;
}
...
@media only screen and (max-width: 600px) {
    ...
    .page-id-193.elementor-page-193 form.woocommerce-cart-form>table.shop_table.shop_table_responsive.cart.woocommerce-cart-form__contents>tbody>tr>.product-name:before {
        content: none;
    }

    .page-id-193.elementor-page-193 .elementor-widget-shortcode>.elementor-widget-container>.elementor-shortcode>.woocommerce>form>table>tbody>tr>.product-thumbnail:before {
        content: none;
    }
...
/*START REGISTER*/
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form#regform>:nth-child(3),
...
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form#regform>:nth-child(4)>input#reg_lastname,
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form#regform>:nth-child(3)>input#reg_firstname,
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form#regform>:nth-child(5)>input#reg_email,
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form#regform>:nth-child(6)>span.password-input>input#reg_password {
    display: block !important;
    width: 100%;
    height: 50px;
    padding: 0 16px;
...
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form#regform>:nth-child(4)>input#reg_lastname:focus,
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form#regform>:nth-child(3)>input#reg_firstname:focus,
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form#regform>:nth-child(5)>input#reg_email:focus,
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form#regform>:nth-child(6)>span.password-input>input#reg_password:focus {
    border-color: #1e73be !important;
}

.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form#regform>:nth-child(4)>input#reg_lastname:hover,
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form#regform>:nth-child(3)>input#reg_firstname:hover,
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form#regform>:nth-child(5)>input#reg_email:hover,
.page-id-194.elementor-page-194 .woocommerce .wpmc-steps-wrapper .wpmc-step-item>#checkout_login>form#regform>:nth-child(6)>span.password-input>input#reg_password:hover {
    border-color: #7e7d7e !important;
}
...
/* 16-aug */
.elementor-5811 .elementor-element.elementor-element-8fce522 .elementor-heading-title,
.elementor-5811 .elementor-element.elementor-element-b3d08a8 .elementor-heading-title,
.elementor-5811 .elementor-element.elementor-element-a1e3f68 .elementor-heading-title {
...
.elementor-5811 .elementor-element.elementor-element-8fce522>.elementor-widget-container,
.elementor-5811 .elementor-element.elementor-element-b3d08a8>.elementor-widget-container,
.elementor-5811 .elementor-element.elementor-element-a1e3f68>.elementor-widget-container>h6.elementor-heading-title.elementor-size-default {
    font-size: 0.9rem;
}

.elementor-5811 .elementor-element.elementor-element-8fce522>.elementor-widget-container,
.elementor-5811 .elementor-element.elementor-element-b3d08a8>.elementor-widget-container,
.elementor-5811 .elementor-element.elementor-element-a1e3f68>.elementor-widget-container {
    padding: 6% 0% 6% 0%;
...
.elementor-5811 .elementor-element.elementor-element-e9eac5d .elementor-post__title,
.elementor-5811 .elementor-element.elementor-element-e9eac5d .elementor-post__title a {
    font-family: "Sofia Pro Light", Sans-serif;
    font-size: 1.25rem;
    font-weight: 500;
    font-weight: 500;
...
.userImg {
    background-image: url(https://secure.gravatar.com/avatar/4bb1746…?s=50&d=mm&r=g);
...
#menu-1-e71767d>li .elementor-item.elementor-item-active.has-submenu:first-child:hover,
#menu-1-e71767d>li .elementor-item.elementor-item-active.has-submenu:first-child:focus {
    color: #d28a40;
    fill: #d28a40;
}
...
/* 3rd-table */
.woocommerce-view-subscription table.shop_table.shop_table_responsive.my_account_orders.woocommerce-orders-table.woocommerce-MyAccount-orders.woocommerce-orders-table--orders thead,
.woocommerce-view-subscription table.shop_table.shop_table_responsive.my_account_orders.woocommerce-orders-table.woocommerce-MyAccount-orders.woocommerce-orders-table--orders tbody {
    font-size: 14.45px;
    color: #414141;
}
...
td.subscription-actions.order-actions.woocommerce-orders-table__cell.woocommerce-orders-table__cell-subscription-actions.woocommerce-orders-table__cell-order-actions>.view,
...
td.subscription-actions.order-actions.woocommerce-orders-table__cell.woocommerce-orders-table__cell-subscription-actions.woocommerce-orders-table__cell-order-actions>.view:hover,
...
.woocommerce-view-order tr.woocommerce-table__line-item.order_item td.woocommerce-table__product-name.product-name,
.woocommerce-view-order tr.woocommerce-table__line-item.order_item td.woocommerce-table__product-total.product-total {
    border-top: 1px solid rgba(0, 0, 0, .1);
...
.woocommerce-edit-address p#update_all_subscriptions_addresses_field~p>button.button:hover,
.woocommerce-edit-address p#update_all_subscriptions_addresses_field~p>button.button:focus,
.woocommerce-edit-address p#update_all_subscriptions_addresses_field~p>button.button:visited {
    color: #ffffff;
...
.woocommerce-payment-methods .woocommerce-account div.wc-accontent-inner,
.woocommerce-payment-methods .woocommerce-account div.woocommerce-MyAccount-content {
    background-color: #f4f4f4;
}
...
.day-trading-card .fa-graduation-cap:before {
    content: "" !important;
    /* background-image: url(https://revolutiontradingpros.com/wp-content/uploads/2023/02/61ae223a84381-bpfull-1-fotor-bg-remover-2023081217353.png) !important;
    background-color: white;
    background-position: center center;
    background-repeat: no-repeat;
    background-size: cover;
...
.small-accounts-card .fa-graduation-cap:before {
    content: "" !important;
    /* background-image: url(https://revolutiontradingpros.com/wp-content/uploads/2023/02/processed-e88554c1-5f26-426a-82ee-534700fc1ac4_EJnmPH2F1-fotor-bg-remover-20230812162558bg-chng.png) !important;
...
/* span.dashboard-menu-item-icon.icon-candle-stick:after{
	content: ""!important;
     background-image: url(https://revolutiontradingpros.com/wp-content/uploads/2023/02/icons8-myspace-1.svg)!important; 
    background-color: #fff;
    background-position: center center;
    background-repeat: no-repeat;
    background-size: cover;
...
ul.page-share-list li.fb-wrap {
    background-image: url('https://revolutiontradingpros.com/wp-content/uploads/2024/01/facebook-icon.svg');
}

ul.page-share-list li.fb-wrap:hover {
    background-image: url('https://revolutiontradingpros.com/wp-content/uploads/2024/01/facebook-icon-white.svg');
    background-color: #0e6ac4;
}

ul.page-share-list li.tweet-wrap {
    background-image: url('https://revolutiontradingpros.com/wp-content/uploads/2024/01/x-icon.png');
}

ul.page-share-list li.tweet-wrap:hover {
    background-image: url('https://revolutiontradingpros.com/wp-content/uploads/2024/01/x-icon-white.png');
    background-color: #000;
}

ul.page-share-list li.share-wrap {
    background-image: url('https://revolutiontradingpros.com/wp-content/uploads/2024/01/share-icon.png');
    margin-right: -1px;
}

ul.page-share-list li.share-wrap:hover {
    background-image: url('https://revolutiontradingpros.com/wp-content/uploads/2024/01/share-icon-white.png');
...
li.spx-profit-pulse span.cstooltiptext+a:before {
    background-image: url(https://revolutiontradingpros.com/wp-content/uploads/2023/02/unnamed.png) !important;
    background-color: #fff;
}
...
.spx-profit-pulse-card .fa-graduation-cap:before {
    content: "" !important;
    background-image: url(https://revolutiontradingpros.com/wp-content/uploads/2023/02/unnamed-fotor-bg-remover-20230819122532.png) !important;
    background-position: center center;
    background-repeat: no-repeat;
    background-size: cover;
...
span.dashboard-profile-photo:before {
    content: "";
    background: url("https://secure.gravatar.com/avatar/3a70a6b6793acd7d0f7aad0908d7bed2?s=32&d=mm&r=g");
    width: 32px;
    height: 32px;
    border-radius: 30px;
    position: unset;
...
.account-primary-menu.is-collapsed .dashboard-menu-item-icon:hover:before {
    -webkit-transform: scale(1);
    -ms-transform: scale(1);
    transform: scale(1);
