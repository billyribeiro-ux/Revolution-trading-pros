...
echo (string) apply_filters( 'woocommerce_email_footer_text', get_option( 'woocommerce_email_footer_text', '' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
