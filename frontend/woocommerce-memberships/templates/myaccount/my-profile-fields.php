				...
				<?php foreach ( $profile_fields as $profile_field ) : ?>
					<tr>
						<td>
							...
							<?php if ( $profile_field->is_required() ) : ?>
								<abbr class="required" title="<?php echo esc_attr_x( 'required', 'Required input field', 'woocommerce-memberships' ); ?>">*</abbr>
							<?php else : ?>
								<span class="optional">(<?php echo esc_html_x( 'optional', 'Optional input field', 'woocommerce-memberships' ); ?>)</span>
							<?php endif; ?>
						</td>
						<td>
