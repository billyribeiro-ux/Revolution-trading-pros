...
<?php else : ?>
	...
	<?php echo wp_kses_post( wc_memberships_get_members_area_page_links( $customer_membership->get_plan(), 'my-membership-sensei', $restricted_content ) ); ?>
					...
					<?php foreach ( $my_membership_sensei_columns as $column_id => $column_name ) : ?>
						...
						<?php elseif ( 'membership-sensei-actions' === $column_id ) : ?>
							...
							<td class="membership-sensei-actions order-actions" data-title="<?php echo esc_attr( $column_name ); ?>">
								<?php echo wp_kses_post( wc_memberships_get_members_area_action_links( 'my-membership-sensei', $customer_membership, $member_post ) ); ?>
							</td>
