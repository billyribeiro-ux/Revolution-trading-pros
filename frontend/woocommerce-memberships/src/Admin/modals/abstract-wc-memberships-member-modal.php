		...
		<article>
			<form id="<?php echo esc_attr( $this->get_id() ); ?>">
				...
				<div id="wc-memberships-modal-select-existing-user">
					...
					<?php echo $this->get_user_search_field_html(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
				...
				<div id="wc-memberships-modal-create-new-user" style="display: none;">
					...
					<?php echo $this->get_new_user_fields_html(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
				</div>
