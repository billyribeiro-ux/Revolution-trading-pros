...
class WC_Memberships_Admin_Import_Export_Handler {
	...
	public function render_admin_page() {
		...
		?>
		<div class="wrap woocommerce woocommerce-memberships woocommerce-memberships-import-export <?php echo esc_attr( $section_class ); ?>">
	...
	public function render_file_upload_field( $field ) {
		...
		<tr valign="top">
			...
			<td class="forminp forminp-<?php echo sanitize_html_class( $field['type'] ) ?>">
				...
				/><br /><p class="description"><?php echo esc_html( $field['desc_tip'] ); ?></p>
			</td>
		</tr>
		<?php
	}
	...
	public function render_date_range_field( $field ) {
		...
		<tr valign="top">
			...
			<td class="forminp forminp-<?php echo sanitize_html_class( $field['type'] ) ?>">
				...
				<br /><p class="description"><?php echo wp_kses_post( $field['desc'] ); ?></p>
			</td>
		</tr>
		<?php
	}
