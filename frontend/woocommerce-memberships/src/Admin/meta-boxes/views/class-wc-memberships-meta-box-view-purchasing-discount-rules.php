				...
				<tr>
					...
					<?php if ( 'membership_plan' === $context ) : ?>
						...
						<th scope="col" class="purchasing-discount-objects objects-column">
							...
							<?php echo wc_help_tip( __( 'Search&hellip; or leave blank to apply to all', 'woocommerce-memberships' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
						</th>
				...
				<tr>
					<td colspan="<?php echo esc_attr( $colspan ); ?>">
						...
						if ( 'membership_plan' === $context || ! empty( $membership_plans ) ) {
							...
							printf( esc_html__( 'To create member discounts, please %s', 'woocommerce-memberships' ),
