...
class Members_Directory extends Block implements Dynamic_Content_Block {
	...
	public const BLOCK_NAME = 'woocommerce-memberships/directory';
	...
	public function render( $attributes, $content ) {
		...
		// Add page ID to the attributes for the frontend
		$block_data = $attributes;
		$block_data['pageId'] = get_queried_object_id();
		...
		<div
			...
			data-directory-data='<?php echo json_encode( $block_data ); ?>'
