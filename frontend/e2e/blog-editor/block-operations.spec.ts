...
test.describe('Block Operations - CRUD', () => {
  ...
  test.describe('Block Editing', () => {
    ...
    test('should edit heading content and level', async ({ adminPage, blockHelper }) => {
      ...
      // Edit content
      const editableContent = adminPage.locator('[data-block-type="heading"] [contenteditable="true"], [data-block-type="heading"] input').first();
      await editableContent.fill('Test Heading');

      // Change heading level
      const levelSelector = adminPage.locator('[data-testid="heading-level"], select[name="level"]').first();
    ...
    test('should edit code block with syntax highlighting', async ({ adminPage, blockHelper }) => {
      ...
      const codeArea = adminPage.locator('[data-block-type="code"] textarea, [data-block-type="code"] [contenteditable]').first();
      await codeArea.fill('const test = "Hello World";');

      // Select language
      const languageSelector = adminPage.locator('select[name="language"], [data-testid="code-language"]').first();
    ...
    test('should edit button text and link', async ({ adminPage, blockHelper }) => {
      ...
      // Edit button text
      const buttonText = adminPage.locator('[data-block-type="button"] [contenteditable], [data-block-type="button"] input[name="text"]').first();
      await buttonText.fill('Click Me');

      // Edit link
      const linkInput = adminPage.locator('input[name="linkUrl"], [data-testid="button-link"]').first();
    ...
    test('should edit ticker symbol', async ({ adminPage, blockHelper }) => {
      ...
      const tickerInput = adminPage.locator('[data-block-type="ticker"] input, input[name="ticker"]').first();
    ...
    test('should handle inline formatting (bold, italic)', async ({ adminPage, blockHelper }) => {
      ...
      const hasBold = await formattedContent.count() > 0 || await editableContent.innerHTML().then(html => html.includes('<strong>') || html.includes('<b>'));
  ...
  test.describe('Block Deletion', () => {
    ...
    test('should confirm deletion for important blocks', async ({ adminPage, blockHelper }) => {
      ...
      const deleteBtn = adminPage.locator('[data-testid="delete-block-btn"], button[aria-label="Delete block"]').first();
  ...
  test.describe('Block Reordering', () => {
    ...
    test('should not move first block up', async ({ adminPage, blockHelper }) => {
      ...
      const moveUpBtn = adminPage.locator('[data-testid="move-block-up"], button[aria-label="Move up"]').first();
    ...
    test('should not move last block down', async ({ adminPage, blockHelper }) => {
      ...
      const moveDownBtn = adminPage.locator('[data-testid="move-block-down"], button[aria-label="Move down"]').first();
  ...
  test.describe('Block Settings', () => {
    test('should open block settings panel', async ({ adminPage, blockHelper }) => {
      ...
      const settingsButton = adminPage.locator('[data-testid="block-settings-toggle"], button[aria-label="Settings"]').first();
      await settingsButton.click();

      const settingsPanel = adminPage.locator('.block-settings-panel, [data-testid="block-settings"]');
    ...
    test('should change text alignment', async ({ adminPage, blockHelper }) => {
      ...
      // Change alignment
      const centerAlign = adminPage.locator('[data-align="center"], button[aria-label="Align center"]').first();
    ...
    test('should change background color', async ({ adminPage, blockHelper }) => {
      ...
      if (await settingsButton.isVisible()) {
        ...
        const colorInput = adminPage.locator('input[name="backgroundColor"], [data-testid="bg-color-picker"]').first();
    ...
    test('should change font size', async ({ adminPage, blockHelper }) => {
      ...
      if (await settingsButton.isVisible()) {
        ...
        const fontSizeInput = adminPage.locator('input[name="fontSize"], select[name="fontSize"]').first();
    ...
    test('should add custom CSS class', async ({ adminPage, blockHelper }) => {
      ...
      if (await settingsButton.isVisible()) {
        ...
        const classInput = adminPage.locator('input[name="customClass"], [data-testid="custom-class-input"]').first();
    ...
    test('should set block-specific settings', async ({ adminPage, blockHelper }) => {
      ...
      if (await settingsButton.isVisible()) {
        ...
        const columnCountInput = adminPage.locator('input[name="columnCount"], select[name="columnCount"]').first();
  ...
  test.describe('Block Search and Filter', () => {
    test('should search blocks by name', async ({ adminPage, blockHelper }) => {
      ...
      const searchInput = adminPage.locator('input[placeholder*="Search"], .block-search-input').first();
    ...
    test('should filter blocks by category', async ({ adminPage, blockHelper }) => {
      ...
      const categoryTab = adminPage.locator('[data-category="trading"], button:has-text("Trading")').first();
    ...
    test('should show no results message for invalid search', async ({ adminPage, blockHelper }) => {
      await blockHelper.openBlockInserter();
  ...
  test.describe('Error Handling', () => {
    test('should show error when block creation fails', async ({ adminPage, mockApi, blockHelper }) => {
      // Mock API error
  ...
  test.describe('Performance', () => {
    ...
    test('should handle 50+ blocks without performance degradation', async ({ adminPage, blockHelper }) => {
  ...
  test.describe('Accessibility', () => {
    ...
    test('should have proper ARIA labels on blocks', async ({ adminPage, blockHelper, a11yHelper }) => {
      await blockHelper.addBlock('paragraph');
    ...
    test('should support keyboard navigation between blocks', async ({ adminPage, blockHelper }) => {
      await blockHelper.addBlock('paragraph');
      await blockHelper.addBlock('heading');
      await blockHelper.addBlock('quote');
