...
test.describe('AI Assistant Features', () => {
  ...
  test.describe('AI Assistant Panel', () => {
    ...
    test('should close AI assistant panel', async ({ adminPage, editorHelper }) => {
      ...
      const closeButton = adminPage.locator('[data-testid="close-ai-panel"], button[aria-label="Close AI Assistant"]').first();
    ...
    test('should show AI prompt input', async ({ adminPage, editorHelper }) => {
      ...
      const promptInput = adminPage.locator('textarea[placeholder*="AI"], input[placeholder*="AI"], [data-testid="ai-prompt-input"]').first();
  ...
  test.describe('Content Generation', () => {
    test('should generate content from prompt', async ({ adminPage, mockApi, editorHelper, blockHelper }) => {
      await editorHelper.openAIAssistant();

      const promptInput = adminPage.locator('textarea[placeholder*="AI"], [data-testid="ai-prompt-input"]').first();
      if (await promptInput.isVisible({ timeout: 2000 }).catch(() => false)) {
        ...
        const generateButton = adminPage.locator('button:has-text("Generate"), [data-testid="ai-generate-btn"]').first();
        ...
        const generatedContent = adminPage.locator('.ai-generated-content, [data-testid="ai-output"]');
    ...
    test('should insert generated content as block', async ({ adminPage, mockApi, editorHelper, blockHelper }) => {
      ...
      if (await promptInput.isVisible({ timeout: 2000 }).catch(() => false)) {
        ...
        const insertButton = adminPage.locator('button:has-text("Insert"), [data-testid="ai-insert-btn"]').first();
    ...
    test('should generate content with specific tone', async ({ adminPage, editorHelper }) => {
      ...
      // Select tone option
      const toneSelector = adminPage.locator('select[name="tone"], [data-testid="ai-tone-selector"]').first();
    ...
    test('should generate content with specific length', async ({ adminPage, editorHelper }) => {
      ...
      const lengthSelector = adminPage.locator('select[name="length"], [data-testid="ai-length-selector"]').first();
    ...
    test('should show loading state during generation', async ({ adminPage, mockApi, editorHelper }) => {
      // Add delay to mock
  ...
  test.describe('Summarization', () => {
    test('should summarize existing content', async ({ adminPage, editorHelper, blockHelper }) => {
      ...
      await blockHelper.editBlockContent(0, 'This is a long paragraph with a lot of content that needs to be summarized. It contains multiple sentences about various topics including trading strategies, market analysis, and risk management. The content is detailed and comprehensive.');

      await editorHelper.openAIAssistant();

      const summarizeButton = adminPage.locator('button:has-text("Summarize"), [data-testid="ai-summarize-btn"]').first();
    ...
    test('should summarize selected text only', async ({ adminPage, editorHelper, blockHelper }) => {
      await blockHelper.addBlock('paragraph');
      await blockHelper.editBlockContent(0, 'First paragraph content. Second paragraph content that should be summarized. Third paragraph content.');
      ...
      const summarizeButton = adminPage.locator('button:has-text("Summarize selection"), [data-testid="ai-summarize-selection"]').first();
  ...
  test.describe('Translation', () => {
    test('should translate content to different language', async ({ adminPage, editorHelper, blockHelper }) => {
      await blockHelper.addBlock('paragraph');
      await blockHelper.editBlockContent(0, 'This is English content to translate.');

      await editorHelper.openAIAssistant();

      const translateButton = adminPage.locator('button:has-text("Translate"), [data-testid="ai-translate-btn"]').first();
      if (await translateButton.isVisible({ timeout: 2000 }).catch(() => false)) {
        // Select target language
        const languageSelector = adminPage.locator('select[name="targetLanguage"], [data-testid="ai-language-selector"]').first();
        ...
        const translation = adminPage.locator('.ai-translation, [data-testid="ai-translation-output"]');
  ...
  test.describe('Content Improvement', () => {
    test('should improve grammar and style', async ({ adminPage, editorHelper, blockHelper }) => {
      await blockHelper.addBlock('paragraph');
      await blockHelper.editBlockContent(0, 'this is content with bad grammer and styel issues that need fixing.');

      await editorHelper.openAIAssistant();

      const improveButton = adminPage.locator('button:has-text("Improve"), [data-testid="ai-improve-btn"]').first();
    ...
    test('should expand content', async ({ adminPage, editorHelper, blockHelper }) => {
      ...
      const expandButton = adminPage.locator('button:has-text("Expand"), [data-testid="ai-expand-btn"]').first();
    ...
    test('should shorten content', async ({ adminPage, editorHelper, blockHelper }) => {
      await blockHelper.addBlock('paragraph');
      await blockHelper.editBlockContent(0, 'This is a very long piece of content that contains many words and sentences that could potentially be shortened or condensed into a more concise form without losing the essential meaning.');

      await editorHelper.openAIAssistant();

      const shortenButton = adminPage.locator('button:has-text("Shorten"), [data-testid="ai-shorten-btn"]').first();
    ...
    test('should change tone of content', async ({ adminPage, editorHelper, blockHelper }) => {
      ...
      const toneButton = adminPage.locator('button:has-text("Make Professional"), [data-testid="ai-change-tone-btn"]').first();
  ...
  test.describe('AI-Generated Blocks', () => {
    ...
    test('should configure AI block prompt', async ({ adminPage, blockHelper }) => {
      ...
      const promptInput = adminPage.locator('[data-block-type="aiGenerated"] input, [data-block-type="aiGenerated"] textarea').first();
    ...
    test('should regenerate AI content', async ({ adminPage, blockHelper }) => {
      ...
      const regenerateButton = adminPage.locator('[data-testid="ai-regenerate"], button:has-text("Regenerate")').first();
  ...
  test.describe('AI SEO Suggestions', () => {
    test('should provide SEO title suggestions', async ({ adminPage, editorHelper, blockHelper }) => {
      ...
      const seoButton = adminPage.locator('button:has-text("SEO"), [data-testid="ai-seo-btn"]').first();
      if (await seoButton.isVisible({ timeout: 2000 }).catch(() => false)) {
        await seoButton.click();

        await adminPage.waitForTimeout(2000);

        const suggestions = adminPage.locator('.seo-suggestions, [data-testid="ai-seo-suggestions"]');
    ...
    test('should generate meta description', async ({ adminPage, editorHelper, blockHelper }) => {
      ...
      const metaButton = adminPage.locator('button:has-text("Meta Description"), [data-testid="ai-meta-desc-btn"]').first();
    ...
    test('should suggest keywords', async ({ adminPage, editorHelper, blockHelper }) => {
      ...
      const keywordsButton = adminPage.locator('button:has-text("Keywords"), [data-testid="ai-keywords-btn"]').first();
  ...
  test.describe('Error Handling', () => {
    test('should handle AI service errors gracefully', async ({ adminPage, mockApi, editorHelper }) => {
      // Mock error response
      await adminPage.route('**/api/ai/**', async (route) => {
        await route.fulfill({
          status: 500,
      ...
      if (await promptInput.isVisible({ timeout: 2000 }).catch(() => false)) {
        ...
        const errorMessage = adminPage.locator('.ai-error, [data-testid="ai-error"], .error-message');
    ...
    test('should handle timeout gracefully', async ({ adminPage, mockApi, editorHelper }) => {
      ...
      if (await promptInput.isVisible({ timeout: 2000 }).catch(() => false)) {
        ...
        const cancelButton = adminPage.locator('button:has-text("Cancel"), [data-testid="ai-cancel-btn"]').first();
    ...
    test('should validate empty prompts', async ({ adminPage, editorHelper }) => {
      ...
      if (await generateButton.isVisible({ timeout: 2000 }).catch(() => false)) {
        ...
        const hasError = await adminPage.locator('.validation-error, [data-testid="prompt-required"]').isVisible({ timeout: 1000 }).catch(() => false);
  ...
  test.describe('Usage Tracking', () => {
    ...
    test('should warn when approaching quota limit', async ({ adminPage, mockApi, editorHelper }) => {
      ...
      const warningMessage = adminPage.locator('.ai-quota-warning, [data-testid="ai-quota-warning"]');
  ...
  test.describe('Accessibility', () => {
    ...
    test('should announce AI actions to screen readers', async ({ adminPage, editorHelper, a11yHelper }) => {
      await editorHelper.openAIAssistant();
  ...
  test.describe('Performance', () => {
    ...
    test('should not block editor while AI processing', async ({ adminPage, mockApi, editorHelper, blockHelper }) => {
