...
//				RIGHT JOIN {$wpdb->prefix}posts AS P ON T.element_id = P.ID
...
//			";
		...
		$missing_atts = $wpdb->get_results(   // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared
					$wpdb->prepare(
							"
								SELECT *
								FROM {$wpdb->prefix}icl_translations AS T
...
//		$query = "
//				UPDATE {$wpdb->prefix}icl_translations AS T
//				INNER JOIN {$wpdb->prefix}posts AS P ON T.element_id = P.ID
