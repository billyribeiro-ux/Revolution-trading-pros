		...
		foreach ( $this->emailsubjects as $email_key => $emailclass )
		{
			$this->inputfields_param[ $email_key ] =
				array ( //	'toggletitle' => __( 'Select CC, BCC and Attachment Files for: ', wc_email_att::TEXT_DOMAIN ).$emailclass['title'],
						...
						'chk_show_notes_location'	=> 'show_notes_location[' . $email_key . ']'
					);
		}
	}
...
//				'desc'		=> __( 'Select desc', wc_email_att::TEXT_DOMAIN ),
	...
	protected function get_general_setting_fields()
	{
		...
		$this->fields[] = array(
				'type'		=> 'select',
				'id'		=> self::PREFIX_JS_NAMES . 'show_notes_location',
				'title'		=> __( 'Location of Notification:', WC_Email_Att::TEXT_DOMAIN ),
				'default'	=> $this->options['show_notes_location'],
				'desc'		=> __( 'Select where you want to show the notification headline and text', wc_email_att::TEXT_DOMAIN ),
//				'desc_tip'	=> __( 'Select the type of E-Mail, where you want to set or change the atttachments from the dropdown list.', WC_Email_Att::TEXT_DOMAIN ),
				'options'	=> array(
									''			=> __( 'In footer (= default)', wc_email_att::TEXT_DOMAIN ),
									'top'		=> __( 'At top of E-Mail body', wc_email_att::TEXT_DOMAIN ),
									'inside'	=> __( 'At top, after heading text', wc_email_att::TEXT_DOMAIN )
								),
				'class'		=> ''
				);
	...
	public function save_settings_page_options()
	{
		...
		$this->options['show_notes_location'] = isset( $_REQUEST[ self::PREFIX_JS_NAMES . 'show_notes_location' ] ) ?  $_REQUEST[ self::PREFIX_JS_NAMES . 'show_notes_location' ] : '';
		...
		WC_Email_Att::$admin_message = __( 'Options saved', WC_Email_Att::TEXT_DOMAIN );
