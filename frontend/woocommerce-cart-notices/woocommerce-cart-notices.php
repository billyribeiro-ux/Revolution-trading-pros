...
class WC_Cart_Notices_Loader {
	...
	public const PLUGIN_NAME = 'WooCommerce Cart Notices';

	/** @var WC_Cart_Notices_Loader|null single instance of this class */
	protected static ?WC_Cart_Notices_Loader $instance = null;
	...
	public function __clone() {
		...
		_doing_it_wrong( __FUNCTION__, esc_html( sprintf( 'You cannot clone instances of %s.', get_class( $this ) ) ), '1.9.0' );
	}
	...
	public function __wakeup() {
		...
		_doing_it_wrong( __FUNCTION__, esc_html( sprintf( 'You cannot unserialize instances of %s.', get_class( $this ) ) ), '1.9.0' );
	}
	 ...
	 * @since 1.9.0
	 */
	protected function load_framework() : void
	{
	 ...
	 */
	public static function instance() : WC_Cart_Notices_Loader
	{
