		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
			<dl class="grid grid-cols-2 md:grid-cols-4 gap-8">
				<div class="text-center group cursor-default">
					<dt
						class="text-rtp-muted font-medium text-xs uppercase tracking-wider mb-2 group-hover:text-emerald-400 transition-colors"
					>
						Historical Win Rate
					</dt>
		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
			...
			<div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
				<div
					...
					'monthly'
						? 'border-rtp-emerald opacity-100 scale-105 shadow-xl shadow-emerald-500/10'
				...
				>
					...
					<ul class="space-y-4 mb-8 text-sm text-rtp-muted">
						<li class="flex gap-3">
							<span class="text-rtp-emerald">✓</span> 2-4 Premium Swings / Week
						</li>
						<li class="flex gap-3">
							<span class="text-rtp-emerald">✓</span> Instant SMS & Email Alerts
						</li>
						<li class="flex gap-3">
							<span class="text-rtp-emerald">✓</span> Private Discord Community
						</li>
				...
				>
					...
					<div
						class="text-xs font-mono text-rtp-emerald bg-rtp-bg p-2 rounded mb-6 text-center border border-rtp-border"
					>
						Save 20% ($2.54 / day)
					</div>
					<ul class="space-y-4 mb-8 text-sm text-rtp-muted">
