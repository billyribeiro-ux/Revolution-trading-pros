    ...
    const faqList = [
        {
            ...
            answer: "No. While the trading is fast-paced, we prioritize education. We provide a comprehensive 'New Member' onboarding video series to help you understand our levels, terminology, and platform execution before you take your first trade."
        },
        {
            question: 'What platform is the room hosted on?',
            answer: 'We host our live room on a private, boosted Discord server. This allows for low-latency Voice Channels (sub-200ms) and crisp 1080p Screen Share, accessible from desktop or mobile.'
        },
        {
            question: 'What specific instruments do you trade?',
            answer: 'We specialize in SPX (S&P 500 Index) options, specifically 0DTE (Zero Days to Expiration). We occasionally trade SPY, QQQ, and futures (ES/NQ) when setups present high probability, but SPX is our primary focus due to tax benefits and liquidity.'
        },
        {
            question: 'How much capital do I need to start?',
            answer: 'We recommend a starting account size of at least $2,000 to trade comfortably with proper risk management. However, many members start with less using cash accounts to avoid PDT (Pattern Day Trader) rules.'
        },
        {
            question: 'Do you offer a free trial?',
            answer: 'We do not offer free trials to maintain the integrity and quality of our community. We focus on dedicated traders who are ready to commit to their education. We do offer a 30-day money-back guarantee if you feel the value wasn\'t delivered.'
        },
        {
            question: 'Is this just copy-trading or signals?',
            answer: 'This is an educational room first. While we call out every trade we take live (Entry, Stop, Target), the goal is for you to learn the "Why" behind the trade so you can eventually become self-sufficient.'
        },
        {
            question: 'What happens if I miss the live session?',
            answer: 'All key levels, trade recaps, and educational lessons are posted in text channels. We also record major educational webinars. However, the live voice commentary is exclusive to the live session hours.'
        },
        {
            question: 'Can I trade on my phone?',
            answer: 'Yes. Discord has an excellent mobile app. You can listen to the voice commentary and see the screen share on your phone while executing trades on your broker\'s mobile app.'
        },
        {
            question: 'What is the win rate of the room?',
            answer: 'Win rates vary by market conditions. Historically, our strategy targets a 70%+ win rate with a strict 1:2 or 1:3 risk-to-reward ratio. We prioritize risk management over "calling tops and bottoms."'
        },
        {
            question: 'How do I cancel my subscription?',
            answer: 'You have full control. You can cancel anytime via your user dashboard or the Stripe portal link provided in your welcome email. Access continues until the end of your billing cycle.'
        }
    ];
...
>
    <section class="relative min-h-[90vh] flex items-center overflow-hidden py-24 lg:py-0">
        ...
        >
            <div class="text-center lg:text-left space-y-8">
                ...
                >
                    Join the digital trading floor. Watch our screens, hear our professional voice commentary, and execute
                ...
                >
                    <div class="flex -space-x-3">
                        <div class="w-10 h-10 rounded-full border-2 border-rtp-bg bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white text-xs font-bold shadow-sm">
                            JD
                        </div>
                        <div class="w-10 h-10 rounded-full border-2 border-rtp-bg bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center text-white text-xs font-bold shadow-sm">
                            MK
                        </div>
                        <div class="w-10 h-10 rounded-full border-2 border-rtp-bg bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center text-white text-xs font-bold shadow-sm">
                            SR
                        </div>
                        <div
                ...
                >
                    ...
                    <div class="grid grid-cols-3 h-[400px]">
                        ...
                        <div class="col-span-1 bg-[#2b2b36] p-3 flex flex-col gap-3 overflow-hidden">
                            <div class="text-xs text-gray-500 font-bold mb-2 uppercase tracking-wider">Chat Stream</div>
                            ...
                            <div class="flex gap-2 items-start">
                                <div class="w-6 h-6 rounded-full bg-emerald-500 shrink-0 flex items-center justify-center text-[10px] text-white font-bold">M</div>
                                <div class="text-xs">
                                    <span class="text-emerald-400 font-bold">Mod:</span>
                                    <span class="text-gray-300">Approaching VWAP support at 4500. Watch for the bounce.</span>
                                </div>
                            </div>
                            <div class="flex gap-2 items-start">
                            ...
                            <div class="mt-auto bg-gray-700/50 p-2 rounded text-xs text-gray-400 border border-gray-600/30">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div class="text-center group cursor-default">
                    ...
                    <div class="text-xs font-bold uppercase tracking-widest text-rtp-muted">Active Members</div>
                </div>
                <div class="text-center group cursor-default">
                    <div
    ...
    <section class="py-24 bg-rtp-bg relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center max-w-3xl mx-auto mb-20">
                <span class="text-rtp-primary font-bold uppercase tracking-wider text-sm mb-2 block">The Experience</span>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                >
                    ...
                    <p class="text-rtp-muted text-sm leading-relaxed">
                        No toxicity. No pump and dump. Just a group of serious, funded traders sharing high-quality ideas, news, and
                        psychological support throughout the session.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p use:reveal={{ delay: 100 }} class="text-lg text-rtp-muted mb-6">
                        The S&P 500 Index (SPX) is the premier instrument for professional day traders. Unlike individual stocks like TSLA or NVDA, the SPX offers unique advantages that align with our institutional trading approach.
                    </p>
                    <ul class="space-y-4">
                        <li class="flex gap-4 items-start" use:reveal={{ delay: 150 }}>
                            <div class="w-6 h-6 rounded bg-emerald-500/10 flex items-center justify-center text-emerald-500 mt-1">✓</div>
                            <div>
                                <h4 class="text-white font-bold">Favorable Tax Treatment</h4>
                                <p class="text-sm text-rtp-muted">SPX options fall under Section 1256, meaning 60% of gains are taxed at the lower long-term capital gains rate, regardless of holding period.</p>
                            </div>
                        </li>
                        <li class="flex gap-4 items-start" use:reveal={{ delay: 200 }}>
                            ...
                            <div>
                                ...
                                <p class="text-sm text-rtp-muted">You can never be assigned shares. The index settles to cash, eliminating the risk of overnight gap risk in physical shares.</p>
                            </div>
                        </li>
                        <li class="flex gap-4 items-start" use:reveal={{ delay: 250 }}>
                            ...
                            <div>
                                ...
                                <p class="text-sm text-rtp-muted">Massive volume ensures tight bid/ask spreads, allowing for rapid entries and exits even with large position sizes.</p>
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="relative rounded-2xl overflow-hidden border border-rtp-border shadow-2xl">
                    <div class="absolute inset-0 bg-gradient-to-t from-rtp-bg to-transparent opacity-60 z-10"></div>
                    <div class="bg-gray-900 aspect-video flex items-center justify-center relative">
                        ...
                        <svg class="absolute inset-0 w-full h-full text-rtp-primary opacity-30" viewBox="0 0 100 100" preserveAspectRatio="none">
                            <path d="M0,50 Q25,30 50,50 T100,50" fill="none" stroke="currentColor" stroke-width="0.5" />
                            <path d="M0,50 Q25,20 50,50 T100,50" fill="none" stroke="currentColor" stroke-width="0.5" />
                            <path d="M0,50 Q25,80 50,50 T100,50" fill="none" stroke="currentColor" stroke-width="0.5" />
                        </svg>
                    </div>
                </div>
            </div>
    ...
    <section id="schedule" class="py-24 bg-rtp-bg relative">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <span class="text-rtp-primary font-bold uppercase tracking-wider text-sm mb-2 block">Routine</span>
                <h2 use:reveal class="text-3xl md:text-5xl font-heading font-bold text-rtp-text mb-4">
                    The Daily Trading Routine
                </h2>
                <p class="text-xl text-rtp-muted">Consistency is the hallmark of a professional. This is exactly how we approach every trading day.</p>
            </div>
                ...
                >
                    ...
                    >
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <span class="text-xs font-mono text-rtp-primary bg-rtp-primary/10 px-2 py-1 rounded">AM EST</span>
                        </div>
                        <p class="text-sm text-rtp-muted leading-relaxed">
                            We review overnight action, analyze key economic data drops (CPI/PPI/FOMC), and map out Critical Gamma Levels on the SPX. This prepares us mentally for the scenarios ahead.
                        </p>
                    </div>
                </div>
                ...
                >
                    ...
                    >
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <span class="text-xs font-mono text-emerald-500 bg-emerald-500/10 px-2 py-1 rounded">AM EST</span>
                        </div>
                        <p class="text-sm text-rtp-muted leading-relaxed">
                            High focus. Voice commentary is active. We execute our primary strategies: Opening Range Breakout or Rejection. <span class="text-white font-bold">This is the most profitable window of the day.</span>
                        </p>
                    </div>
                </div>
                ...
                >
                    ...
                    >
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <span class="text-xs font-mono text-rtp-muted bg-rtp-border/30 px-2 py-1 rounded">PM EST</span>
                        </div>
                        <p class="text-sm text-rtp-muted leading-relaxed">
                            Institutional volume slows. We review morning trades, calculate P&L, answer member questions in voice, and scan for afternoon setups. Preservation of morning capital is the goal.
                        </p>
                    </div>
                </div>
                ...
                >
                    ...
                    >
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <span class="text-xs font-mono text-rtp-indigo bg-rtp-indigo/10 px-2 py-1 rounded">PM EST</span>
                        </div>
                        <p class="text-sm text-rtp-muted leading-relaxed">
                            Final hour volatility injection. We look for end-of-day squeezes or flushes (MOC imbalances). All 0DTE positions are closed flat before the closing bell.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section id="pricing" class="py-24 bg-rtp-surface relative">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                 <span class="text-rtp-primary font-bold uppercase tracking-wider text-sm mb-2 block">Investment</span>
                <h2 class="text-3xl md:text-5xl font-heading font-bold text-rtp-text mb-4">
                    Membership Access
                </h2>
                <p class="text-xl text-rtp-muted max-w-2xl mx-auto">
                    Invest in your education. One disciplined trade can pay for the whole year. Cancel anytime.
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
                <div
                    class="bg-rtp-bg p-8 rounded-2xl border transition-all duration-300 {selectedPlan === 'monthly' ? 'border-rtp-primary opacity-100 scale-105 shadow-xl shadow-rtp-primary/10' : 'border-rtp-border opacity-70 hover:opacity-100'}"
                >
                ...
                <div
                    class="bg-rtp-bg p-10 rounded-3xl border-2 shadow-2xl transform relative z-10 transition-all duration-300 {selectedPlan === 'quarterly' ? 'border-rtp-primary shadow-rtp-primary/20 md:scale-110 opacity-100' : 'border-rtp-border shadow-rtp-border/10 md:scale-100 opacity-70 hover:opacity-100'}"
                >
                    <div
                ...
                <div
                    class="bg-rtp-bg p-8 rounded-2xl border transition-all duration-300 relative {selectedPlan === 'annual' ? 'border-emerald-500 opacity-100 scale-105 shadow-xl shadow-emerald-500/10' : 'border-rtp-border opacity-70 hover:opacity-100'}"
                >
                    ...
                    <div class="text-xs font-mono text-rtp-emerald bg-rtp-surface p-2 rounded mb-6 text-center border border-rtp-border">
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                {#each faqList as faq, i}
                    <div class="border border-rtp-border rounded-xl bg-rtp-surface overflow-hidden hover:border-rtp-primary/30 transition-colors">
                        <button
    ...
    <footer class="bg-rtp-bg py-12 border-t border-rtp-border">
        ...
        >
            ...
            <p class="max-w-4xl mx-auto">
                ...
                will have a great impact on your trading account and this can work against you as well as for you.
                Revolution Trading Pros is an educational platform and not a financial advisory service.
                Results shown are not typical. Past performance is not indicative of future results.
            </p>
