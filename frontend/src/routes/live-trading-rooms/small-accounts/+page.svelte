    ...
    const faqList = [
        {
            ...
            answer: 'No. This room is specifically designed for accounts under $25k. We teach you how to use Cash Accounts (which settle T+1 for options) to trade daily without triggering the Pattern Day Trader (PDT) rule.'
        },
        {
            question: 'What is the minimum recommended capital?',
            answer: 'We strictly recommend a minimum of $2,000. While you can technically start with less, $2,000 allows you to trade micro-contracts or single option contracts while adhering to proper risk management rules (risking only 1-2% per trade).'
        },
        {
            question: 'How do you avoid the PDT rule?',
            answer: 'By using a Cash Account rather than a Margin Account. In a Cash Account, options trades settle the next business day (T+1). This means you can trade your entire account balance every single day without restriction, as long as the cash has settled.'
        },
        {
            question: 'What specific instruments do you trade?',
            answer: 'We focus on SPX (S&P 500 Index) 0DTE options. SPX offers favorable tax treatment (Section 1256), cash settlement (no assignment risk), and massive liquidity, making it ideal for scalping small accounts.'
        },
        {
            question: 'Is this room beginner friendly?',
            answer: 'Yes. We assume you are learning. Our "New Member" onboarding covers how to set up your platform, how to read an options chain, and how to execute orders quickly. We focus heavily on risk habits.'
        },
        {
            question: 'Do you trade Futures (ES/NQ)?',
            answer: 'Yes. For members who prefer Futures, we analyze ES and NQ. Futures accounts also do not have the PDT rule, making them another excellent vehicle for small account growth.'
        },
        {
            question: 'What is the win rate?',
            answer: 'Win rates fluctuate with market conditions. Our strategy targets a 70%+ win rate with a 1:2 risk/reward ratio. However, in small account trading, risk management (keeping losers small) is more important than win rate.'
        },
        {
            question: 'Can I trade on mobile?',
            answer: 'Yes, but we recommend a desktop or laptop for the best experience. You can listen to the live voice commentary and see the screen share on the Discord mobile app while executing trades on your broker\'s app.'
        },
        {
            question: 'How many trades do you take per day?',
            answer: 'Quality over quantity. We typically take 2-4 high-conviction trades per day, usually within the first 2 hours of the market open (9:30 AM - 11:30 AM EST).'
        },
        {
            question: 'What happens if I blow up my account?',
            answer: 'We aim to prevent this. Our strict risk rules (hard stops) are designed to keep you in the game. If you are struggling, we offer mentorship channels to review your trades and correct bad habits before capital is lost.'
        }
    ];
...
>
                ...
                >
                    ...
                    >
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="text-[10px] text-rtp-muted uppercase font-bold tracking-wider">Latest Call</div>
    ...
    <section class="py-24 bg-rtp-bg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                     <span class="text-emerald-500 font-bold uppercase tracking-wider text-sm mb-2 block">The Methodology</span>
                    ...
                    <p class="text-lg text-rtp-muted mb-6 leading-relaxed">
                        The Pattern Day Trader (PDT) rule restricts margin accounts under $25k to only 3 day trades per week. <strong>We solve this.</strong>
                    </p>
                    <ul class="space-y-6">
                        <li class="flex gap-4">
                            <div class="w-12 h-12 rounded-full bg-rtp-surface border border-rtp-border flex items-center justify-center shrink-0">
                                <span class="text-emerald-500 font-bold">01</span>
                            </div>
                            <div>
                                <h3 class="text-white font-bold text-lg">Cash Account Mastery</h3>
                                <p class="text-rtp-muted text-sm mt-1">We teach you how to utilize Cash Accounts. Options settle T+1 (next day), meaning you can reuse your cash daily without hitting PDT limits.</p>
                            </div>
                        </li>
                        <li class="flex gap-4">
                            <div class="w-12 h-12 rounded-full bg-rtp-surface border border-rtp-border flex items-center justify-center shrink-0">
                            ...
                            <div>
                                ...
                                <p class="text-rtp-muted text-sm mt-1">The S&P 500 index offers massive liquidity. We scalp quick moves (10-30 minutes) using 0DTE options that offer high percentage returns on small capital.</p>
                            </div>
                        </li>
                        <li class="flex gap-4">
                            <div class="w-12 h-12 rounded-full bg-rtp-surface border border-rtp-border flex items-center justify-center shrink-0">
                            ...
                            <div>
                                ...
                                <p class="text-rtp-muted text-sm mt-1">We never bet the farm. We teach you to risk strictly 1-2% of your account per trade, ensuring you survive the learning curve.</p>
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="relative">
                    <div class="absolute inset-0 bg-gradient-to-r from-emerald-500/20 to-blue-500/20 rounded-3xl blur-2xl"></div>
                    <div class="relative bg-rtp-surface border border-rtp-border rounded-2xl p-8 shadow-2xl">
                        ...
                        <div class="mt-4 bg-rtp-bg p-4 rounded-xl border border-rtp-border/50 flex justify-between items-center">
                             <div>
    ...
    <section id="daily-routine" class="py-24 bg-rtp-bg border-y border-rtp-border">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                 <span class="text-rtp-primary font-bold uppercase tracking-wider text-sm mb-2 block">Structure</span>
    ...
    <section id="pricing" class="py-24 bg-rtp-bg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-center mb-16">
                <div class="bg-rtp-surface p-1.5 rounded-xl border border-rtp-border inline-flex relative shadow-inner">
                    <button
            ...
            <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
                <div
                    class="bg-rtp-surface p-8 rounded-2xl border transition-all duration-300 {selectedPlan === 'monthly' ? 'border-rtp-primary opacity-100 scale-105 shadow-lg shadow-rtp-primary/10' : 'border-rtp-border opacity-70 hover:opacity-100'}"
                >
                    ...
                    <div class="text-xs font-mono text-rtp-muted bg-rtp-bg p-2 rounded mb-6 text-center border border-rtp-border">
                        $9.85 / trading day
                    </div>
                ...
                <div
                    class="bg-rtp-surface p-8 rounded-2xl border transition-all duration-300 {selectedPlan === 'annual' ? 'border-rtp-indigo opacity-100 scale-105 shadow-lg shadow-rtp-indigo/10' : 'border-rtp-border opacity-70 hover:opacity-100'}"
                >
                    ...
                    <div class="text-xs font-mono text-rtp-indigo bg-rtp-bg p-2 rounded mb-6 text-center border border-rtp-border">
            ...
            <div class="mt-12 text-center">
                 ...
                 <div class="flex items-center justify-center gap-2 text-rtp-muted text-sm bg-rtp-surface inline-flex px-4 py-2 rounded-full border border-rtp-border">
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="space-y-4">
                {#each faqList as faq, i}
                    <div class="border border-rtp-border rounded-xl bg-rtp-bg overflow-hidden hover:border-rtp-primary/30 transition-colors">
                        <button
    ...
    >
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <p class="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
                Don't trade alone tomorrow. Join 500+ traders in the live room and start growing your small account correctly.
            </p>
            <a
                href="#pricing"
