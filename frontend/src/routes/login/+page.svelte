...
<style>
    ...
    .enhanced-input::placeholder { color: #475569; }
    ...
    .submit-btn:hover:not(:disabled) .btn-glow { opacity: 0.6; }
    ...
    .forgot-link:hover, .footer-link:hover { color: #a5b4fc; }
    ...
    .footer-text { color: #94a3b8; font-size: 0.9375rem; }
