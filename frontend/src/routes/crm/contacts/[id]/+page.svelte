<script lang="ts">
  ...
  import { IconArrowLeft, IconMail, IconPhone, IconActivity, IconUserCircle } from '@tabler/icons-svelte';
...
<div class="min-h-screen bg-slate-950/95 text-slate-50">
  <div class="mx-auto max-w-6xl px-6 py-6">
    ...
    {:else if error}
      <div class="rounded-xl border border-rose-700/60 bg-rose-950/40 px-4 py-3 text-sm text-rose-200">
        {error}
      </div>
    {:else if contact}
            ...
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1">
                ...
                <div class="mt-2 flex flex-wrap items-center gap-3 text-xs text-slate-300">
                  ...
                  <span class="rounded-full bg-slate-800/80 px-2 py-1">{contact.lifecycle_stage}</span>
