...
<div class="cookie-policy">
	<div class="container">
		...
		<section class="quick-actions">
			<button class="btn btn-primary" on:click={handleManageCookies}>
			...
			{#if $consentStore.hasInteracted}
				<button class="btn btn-secondary" on:click={handleDownloadReceipt}>
					<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
				...
				<button class="btn btn-secondary" on:click={handlePrintReceipt}>
					<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
