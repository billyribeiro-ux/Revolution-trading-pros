...
<svelte:head>
	<title>Getting Started with Explosive Swings | Revolution Trading Pros</title>
	<meta
		name="description"
		content="Welcome to your Revolution Trading Pros Explosive Swings Membership. Get started on the right path with our comprehensive getting started checklist."
	/>
		...
		<section class="dashboard__content-section">
			...
			<h2 class="page-heading">
				<span class="page-heading__text"
					>Welcome to your Revolution Trading Pros Explosive Swings Membership</span
				>
			</h2>
			...
			<div class="intro-container">
				...
				below to learn more about the features included in your Explosive Swings Membership:
			</div>
				...
				<div class="accordion__item" class:is-open={isOpen(0)}>
					...
					>
						<span class="accordion__label">
							...
							<span class="accordion__subtitle"
								><em>Learn about our swing trading alert service and how it works.</em></span
							>
						</span>
					...
					{#if isOpen(0)}
						<div class="accordion__content">
							<p>
								Explosive Swings is our premium alert service focused on high-probability swing
								trades with explosive momentum potential. We trade both stocks and options with hold
								times ranging from 2-14 days.
							</p>
							<p><strong>What You Get:</strong></p>
							<ul>
								<li>Real-time swing trade alerts sent directly to your phone and email</li>
								<li>Detailed entry, exit, and position management instructions</li>
								<li>Clear risk management guidelines for each trade</li>
								<li>Technical analysis and market commentary</li>
								<li>Weekly market outlook and sector analysis</li>
								<li>Performance tracking and complete trade history</li>
							</ul>
							<p><strong>Trading Schedule:</strong></p>
							<ul>
								<li>Alerts sent as opportunities arise (typically 2-5 per week)</li>
								<li>Weekly market outlook published Sunday evenings</li>
								<li>Position updates sent as needed during market hours</li>
							</ul>
						</div>
					{/if}
				</div>
				...
				<div class="accordion__item" class:is-open={isOpen(1)}>
					...
					>
						<span class="accordion__label">
							...
							<span class="accordion__subtitle"
								><em>Configure your notification preferences to receive trade alerts instantly.</em
								></span
							>
						</span>
						<span class="accordion__icon">
					...
					{#if isOpen(1)}
						<div class="accordion__content">
							<p>
								To ensure you receive all trade alerts in real-time, please configure your
							...
							<ol>
								...
								<li>Enable SMS alerts for "Explosive Swings"</li>
							</ol>
							<p><strong>Step 2: Enable Email Alerts</strong></p>
							<ol>
								<li>Verify your email address is correct in your account settings</li>
								<li>Enable email notifications for "Explosive Swings"</li>
								<li>
									Add <strong>alerts@revolutiontradingpros.com</strong> to your email contacts to prevent
									spam filtering
								</li>
							</ol>
							<p>
								<strong>Important:</strong> We recommend enabling both SMS and email alerts to ensure
				...
				<div class="accordion__item" class:is-open={isOpen(2)}>
					...
					>
						<span class="accordion__label">
							...
							<span class="accordion__subtitle"
								><em
									>Learn the basics of swing trading and our approach to capturing explosive moves.</em
								></span
							>
						</span>
						<span class="accordion__icon">
					...
					{#if isOpen(2)}
						<div class="accordion__content">
							<p>
								Swing trading involves holding positions for multiple days to capture larger price
								moves. This strategy offers unique advantages over day trading.
							</p>
							<p><strong>Key Characteristics:</strong></p>
							<ul>
								<li><strong>Multi-Day Holds:</strong> Positions typically held 2-14 days</li>
								<li>
									<strong>Momentum Focus:</strong> We target stocks and options showing explosive momentum
								</li>
								<li>
									<strong>Defined Risk:</strong> Every trade has clear stop loss and profit targets
								</li>
								<li><strong>Less Screen Time:</strong> No need to watch the market all day</li>
							</ul>
							...
							<ul>
								...
								<li>Scale out of winning positions to lock in profits</li>
							...
							<ul>
								<li>
									<a href="/learning-center/swing-trading-basics"
										>Swing Trading Fundamentals Course</a
									>
								</li>
								<li><a href="/learning-center/risk-management">Risk Management Guide</a></li>
								<li>
									<a href="/learning-center/technical-analysis">Technical Analysis Essentials</a>
								</li>
							</ul>
						</div>
					{/if}
				...
				<div class="accordion__item" class:is-open={isOpen(3)}>
					...
					>
						<span class="accordion__label">
							...
							<span class="accordion__subtitle"
								><em>Ensure your brokerage account is properly configured for swing trading.</em
								></span
							>
						</span>
						<span class="accordion__icon">
					...
					{#if isOpen(3)}
						<div class="accordion__content">
							<p>
								To trade swing positions effectively, you'll need a brokerage account with specific
								capabilities:
							</p>
							<p><strong>Required Account Features:</strong></p>
							<ul>
								<li>Options trading approval (Level 2 or higher for spreads)</li>
								<li>Access to major stock exchanges (NYSE, NASDAQ)</li>
								<li>Real-time or delayed market data</li>
								<li>Mobile app for position monitoring</li>
							</ul>
							...
							<div class="charts-columns">
								...
								<div class="copy-column">
									...
									Excellent platform for swing trading with advanced charting and analysis tools. Commission-free
							...
							<div class="charts-columns">
								...
								<div class="copy-column">
									...
									Great for options swing traders. Low fees, excellent mobile app, and powerful portfolio
									management tools.
								</div>
							</div>
							<p>
								<strong>Important:</strong> We recommend having at least $10,000-$25,000 in your account
				...
				<div class="accordion__item" class:is-open={isOpen(4)}>
					...
					>
						<span class="accordion__label">
							...
							<span class="accordion__subtitle"
								><em>Access our library of educational content, tools, and support resources.</em
								></span
							>
						</span>
						<span class="accordion__icon">
					...
					{#if isOpen(4)}
						<div class="accordion__content">
							<p>
								<strong>Trading Terms Glossary</strong><br />
								A comprehensive guide to swing trading terminology and jargon used in our alerts.
							</p>
							<p><a class="resource-link" href="/trading-terms">View Trading Terms Glossary</a></p>

							<p>
								<strong>Support Knowledge Base</strong><br />
								Find answers to common questions about the platform, alerts, and trading strategies.
							</p>
							<p><a class="resource-link" href="/support">Visit Support Knowledge Base</a></p>

							<p>
								<strong>Performance History</strong><br />
								Review our complete trade history and performance metrics.
							</p>
							<p>
								<a class="resource-link" href="/dashboard/explosive-swings/alerts"
									>View Alert Archive</a
								>
							</p>

							<p>
								<strong>Community Forum</strong><br />
								Connect with other Explosive Swings members to share insights and strategies.
							</p>
...
<style>
	...
	.contact-support--container .img {
		flex-shrink: 0;
	}

	.contact-support--container .img svg {
		width: 100px;
		height: auto;
	}
