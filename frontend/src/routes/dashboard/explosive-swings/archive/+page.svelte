<script lang="ts">
  ...
  const monthKeys = $derived(Object.keys(groupedWeeks).sort((a, b) => {
            ...
            {#each groupedWeeks[month] as week (week.id)}
              <article class="week-card">
                ...
                <div class="card-thumbnail">
                  ...
                  <!-- Play overlay -->
                  <a href="/dashboard/explosive-swings/video/{week.id}" class="play-overlay" aria-label="Watch {week.weekTitle}">
                ...
                <div class="card-actions">
                  ...
                  <a href="/dashboard/explosive-swings/alerts?week={week.weekOf}" class="action-btn secondary">
                    View Alerts
                  </a>
                </div>
              </article>
