...
import { logger } from '$lib/utils/logger';
	/**
	 * Small Account Mentorship Dashboard - Pixel-Perfect WordPress Match
	 * ═══════════════════════════════════════════════════════════════════════════
	 *
	...
	const fallbackArticles = [
		...
		},
		{
			...
			href: '/chatroom-archive/small-account-mentorship/12232025',
		...
		},
		{
			...
			excerpt: 'With Expert Trader',
			href: '/chatroom-archive/small-account-mentorship/12222025',
			image: 'https://cdn.simplertrading.com/2019/01/14105015/generic-video-card-min.jpg',
			isVideo: false
		},
		{
		...
		},
		{
			...
			excerpt: 'With Expert Trader',
			href: '/chatroom-archive/small-account-mentorship/12192025',
			image: 'https://cdn.simplertrading.com/2019/01/14105015/generic-video-card-min.jpg',
			isVideo: false
		}
	];
...
<svelte:head>
	<title>Small Account Mentorship | Revolution Trading Pros</title>
...
<div class="dashboard__content">
	...
	<TradingRoomSidebar planSlug="small-account-mentorship" />
</div>
