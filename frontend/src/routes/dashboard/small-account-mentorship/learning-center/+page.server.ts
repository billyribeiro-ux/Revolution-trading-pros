...
export const load: PageServerLoad = async ({ url, fetch }) => {
	...
	// learning_center, room=small-account-mentorship. Old body kept commented
	// per CLAUDE.md "comment-don't-delete" rule.
	//
	...
	try {
		...
		console.error('[dashboard/small-account-mentorship/learning-center] video fetch failed:', e);
		return {
			...baseReturn,
			videos: [] as VideoResponse[],
			meta: { current_page: page, per_page: perPage, total: 0, last_page: 1 },
