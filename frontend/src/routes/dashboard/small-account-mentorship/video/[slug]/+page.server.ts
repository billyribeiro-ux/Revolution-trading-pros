...
export const load: PageServerLoad = async ({ params, fetch, cookies }): Promise<PageData> => {
	...
	try {
		...
		const apiUrl = `${BACKEND_URL}/trading-rooms/day-trading-room/videos/${slug}`;
	...
	const mockVideos = [
		{
			...
			description:
				"<p>You asked for it, you got it. Here are Kody's Bookmap tools and how he uses them to make better informed trades.</p>",
		...
		},
		{
			...
			description:
				'<p>As we head into the new year, here are some key considerations for your trading strategy.</p>',
			videoUrl: 'https://simpler-options.s3.amazonaws.com/nightlyvids/2025/dec29DSG.mp4',
		...
		},
		{
			...
			description:
				"<p>Things can always change, but given how the market closed on Tuesday, it looks like Santa's on his way.</p>",
			videoUrl: 'https://simpler-options.s3.amazonaws.com/nightlyvids/2025/dec29DSG.mp4',
			thumbnailUrl: 'https://cdn.simplertrading.com/2025/05/07134745/SimplerCentral_HG.jpg',
