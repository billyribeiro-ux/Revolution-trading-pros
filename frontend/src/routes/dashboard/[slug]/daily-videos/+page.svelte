<script lang="ts">
	/**
	 * Dynamic Trading Room - Premium Daily Videos
	 * ═══════════════════════════════════════════════════════════════════════════
	 *
	 * 100% PIXEL-PERFECT match to core 2 reference
	 * URL: /dashboard/{slug}/daily-videos
	 *
	...
	const allVideos = [
		{
			...
			videoSlug: 'a-strong-end-of-year'
		},
		{
			id: 2,
		...
		},
		{
			...
			videoSlug: 'setting-up-santa-rally'
		},
		{
			id: 4,
			...
			videoSlug: 'holiday-weekend-market-review'
		},
		{
			id: 5,
			title: 'Ho Ho Whoa!',
		...
		},
		{
			...
			videoSlug: 'a-moment-for-the-vix'
		},
		{
			id: 7,
			...
			videoSlug: 'next-move-spx-tsla-gold'
		},
		{
			id: 8,
			...
			videoSlug: 'stock-pickers-market-12152025'
		},
		{
			id: 9,
			...
			videoSlug: 'what-happened-after-fed'
		},
		{
			id: 10,
			...
			videoSlug: 'one-thing-missing-for-a-bull-run'
		},
		{
			id: 11,
			...
			videoSlug: 'processing-the-latest-cut'
		},
		{
			id: 12,
...
<svelte:head>
	<title>Premium Daily Videos - {room.name} | Revolution Trading Pros</title>
</svelte:head>
						...
						<article class="card-grid-spacer flex-grid-item col-xs-12 col-sm-6 col-md-6 col-lg-4">
							<div class="card flex-grid-panel">
								<figure class="card-media card-media--video">
									<a href="/daily/{slug}/{video.videoSlug}" class="card-image" style="background-image: url({video.thumbnail});">
										<img class="default-background" width="325px" height="183px" alt={video.title} />
									</a>
								</figure>
								<section class="card-body">
									<h4 class="h5 card-title">
										<a href="/daily/{slug}/{video.videoSlug}">
											{video.title}
										</a>
									</h4>
								...
								<footer class="card-footer">
									<a class="btn btn-tiny btn-default" href="/daily/{slug}/{video.videoSlug}">Watch Now</a>
								</footer>
							</div>
						</article>
					{/each}
