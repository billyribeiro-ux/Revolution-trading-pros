<script lang="ts">
	 ...
	 * ═══════════════════════════════════════════════════════════════════════════
	 *
	 * URL: /dashboard/[slug]/learning-center/[lessonSlug]
	...
	let lesson = $derived.by((): LessonWithRelations | undefined => {
		return roomLessons.find(l => l.slug === lessonSlug);
	});
	...
	let currentIndex = $derived(sortedLessons.findIndex(l => l.slug === lessonSlug));
...
{#if !lesson}
	<div class="error-state">
		...
		<p>The lesson "{lessonSlug}" doesn't exist.</p>
