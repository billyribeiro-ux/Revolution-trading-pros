<!--
	URL: /dashboard/swing-trading-room/start-here

	Getting Started with Swing Trading Room - Pixel Perfect Match
	===============================================================================
...
<svelte:head>
	<title>Getting Started with Swing Trading Room | Revolution Trading Pros</title>
	<meta
		name="description"
		content="Welcome to your Revolution Trading Pros Swing Trading Room Membership. Get started on the right path with our comprehensive getting started checklist."
	/>
		...
		<section class="dashboard__content-section">
			...
			<h2 class="page-heading">
				<span class="page-heading__text"
					>Welcome to your Revolution Trading Pros Swing Trading Room Membership</span
				>
			</h2>
			...
			<div class="intro-container">
				...
				below to learn more about the features included in your Swing Trading Room Membership:
			</div>
				...
				<div class="accordion__item" class:is-open={isOpen(0)}>
					...
					{#if isOpen(0)}
						<div class="accordion__content">
							...
							<ul>
								<li>To generate long term wealth</li>
								<li>To gain technical competence in the market</li>
								<li>To have a better understanding of how financial markets work</li>
								<li>To create a consistent source of income through trading</li>
							</ul>
							...
							<ul>
								<li>Weekly, static wire of $987 ($51,324 annually)</li>
						...
						<div class="accordion__content">
							...
							<p>
								...
								complete recording of the trading room each day in our <a
									href="/dashboard/swing-trading-room/trading-room-archive"
