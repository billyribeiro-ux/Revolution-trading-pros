<script lang="ts">
	/**
	 * Day Trading Room - Learning Center
	 * ═══════════════════════════════════════════════════════════════════════════
	...
	// Videos with multi-category support
	const allVideos = [
		{
			id: 1,
		...
		},
		{
			...
			description: 'A deep dive into the indicators that move the market and how to use them effectively.',
			videoSlug: 'understanding-market-indicators'
		},
		{
			id: 9,
			...
			description: 'Learn the fundamentals of options trading from entry to exit strategies.',
			videoSlug: 'options-trading-fundamentals'
		},
		{
			id: 10,
			...
			description: 'Master your emotions and develop the mental discipline needed for successful trading.',
			videoSlug: 'psychology-of-trading'
		},
		{
			id: 11,
			...
			categories: ['530', '2929'],
			categoryLabels: ['Charting', 'Charting/Indicators/Tools'],
			thumbnail: 'https://cdn.simplertrading.com/2025/04/07134838/SimplerCentral_TH.jpg',
			description: 'Take your charting skills to the next level with advanced pattern recognition.',
			videoSlug: 'advanced-charting-techniques'
		}
	];
						...
						<div class="col-xs-12 col-sm-6 col-md-6 col-xl-4 flex-grid-item">
							<article class="article-card">
								...
								<h4 class="h5 article-card__title">
									<a href="/dashboard/day-trading-room/learning-center/{video.videoSlug}">{video.title}</a>
								</h4>
								...
								<a href="/dashboard/day-trading-room/learning-center/{video.videoSlug}" class="btn btn-tiny btn-default">Watch Now</a>
							</article>
						</div>
					{/each}
				</div>
...
<style>
	/* ═══════════════════════════════════════════════════════════════════════════
	   DAY TRADING ROOM LEARNING CENTER - 100% PIXEL-PERFECT MATCH
