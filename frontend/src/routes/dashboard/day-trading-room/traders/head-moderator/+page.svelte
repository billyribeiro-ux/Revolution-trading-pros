<!--
	URL: /dashboard/day-trading-room/traders/head-moderator
	
	Head Moderator Profile Page
	═══════════════════════════════════════════════════════════════════════════
	Apple ICT 11+ Principal Engineer Implementation
	
	Profile and bio for the Day Trading Room head moderator.
...
<header class="dashboard__header">
	<div class="dashboard__header-left">
		<h1 class="dashboard__page-title">Head Moderator</h1>
	</div>
</header>
