<script lang="ts">
	...
	let orderNumber = $derived(
		data.orderDetail?.order_number ||
			data.orderNumber ||
			'RTP-' + Date.now().toString(36).toUpperCase()
	);
	...
	<div class="container">
						...
						{#each orderDetail.items as item (item.name)}
							<div class="typ-order-item">
								<div class="typ-order-item__image">
									{#if item.thumbnail}
										<img src={item.thumbnail} alt={item.name} width="80" height="80" loading="lazy" decoding="async" />
									{:else}
								...
								<div class="typ-order-item__details">
									...
									{#if item.product_type}
										<span class="typ-order-item__type"
											>{getProductTypeLabel(item.product_type)}</span
										>
									{/if}
								...
								<div class="typ-order-item__actions">
									...
									<a href={getAccessUrl(item)} class="typ-order-item__access"> Access Now </a>
								</div>
							</div>
						{/each}
					</div>
		...
		<section class="typ-welcome">
			...
			<div class="typ-welcome__image">
				<img src="/images/welcome-trading.jpg" alt="Welcome to Revolution Trading Pros" width="800" height="600" loading="eager" fetchpriority="high" decoding="sync" />
			</div>
		</section>
