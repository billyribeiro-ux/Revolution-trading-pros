<script lang="ts">
	...
	async function initializeCheckout() {
		...
		if (user.current) {
			const nameParts = (user.current.name || '').split(' ');
			billing.firstName = nameParts[0] || '';
			billing.lastName = nameParts.slice(1).join(' ') || '';
			billing.email = user.current.email || '';
		}
...
{#if !checkoutReady}
	<div class="woocommerce-checkout woocommerce-page">
		<div class="container">
			<div class="checkout-loading" role="status" aria-live="polite">Loading checkout...</div>
		</div>
	</div>
{:else}
	<div class="woocommerce-checkout woocommerce-page">
							...
							<div class="card">
									...
									<div class="billing-fields">
										...
										<div class="form-row form-row-wide">
											<label for="billing_email"
												>Email address <abbr class="required">*</abbr></label
											>
											<input
												type="email"
												id="billing_email"
								...
								<div class="card-footer">
									<div class="checkout-steps-actions">
										...
										<button
											type="button"
											class="btn btn-orange submit-billing"
											onclick={goToPayment}
										>
											Continue to Payment
