	...
	<div class="relative max-w-7xl mx-auto z-10">
		...
		<div class="mb-12" bind:this={headerRef}>
			<div class="flex items-center gap-4 mb-4">
				<div
					class="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-500 p-0.5 shadow-lg shadow-blue-500/50"
				>
				...
				<div>
					<h1
						class="text-5xl md:text-6xl font-heading font-bold bg-gradient-to-r from-blue-300 via-cyan-300 to-teal-300 bg-clip-text text-transparent"
					>
						Day Trading Room
					</h1>
		...
		<div bind:this={contentRef}>
			<div class="relative">
				<div
					class="absolute -inset-1 bg-gradient-to-r from-blue-500 via-cyan-500 to-teal-500 rounded-3xl opacity-30 blur-2xl"
				></div>
				<div
					class="relative bg-slate-900/95 backdrop-blur-xl border border-blue-500/30 rounded-3xl p-8 md:p-12 shadow-2xl"
				>
					<!-- Hero Section -->
					<div class="text-center mb-12">
						<div
							class="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/20 border border-blue-500/30 rounded-full mb-6"
						>
						...
						<p class="text-lg text-slate-300 max-w-3xl mx-auto">
							Join our live day trading room and learn from experienced traders in real-time. Get
							instant trade alerts, market analysis, and learn professional strategies as they
							happen.
						</p>
					</div>
					...
					<div class="grid md:grid-cols-2 gap-6 mb-12">
						<div class="p-6 bg-slate-800/50 rounded-xl border border-slate-700/50">
							...
							<p class="text-slate-300">
								Get instant notifications for every trade setup and exit strategy
							</p>
						</div>
						...
						<div class="p-6 bg-slate-800/50 rounded-xl border border-slate-700/50">
							...
							<p class="text-slate-300">
								Professional chart analysis and technical insights during trading hours
							</p>
						</div>
						...
						<div class="p-6 bg-slate-800/50 rounded-xl border border-slate-700/50">
							...
							<p class="text-slate-300">
								Learn the 'why' behind every trade with detailed explanations
							</p>
						</div>
						...
						<div class="p-6 bg-slate-800/50 rounded-xl border border-slate-700/50">
							...
							<p class="text-slate-300">
								Ask questions and interact with traders and community members
							</p>
						</div>
					</div>
					...
					<div class="grid md:grid-cols-3 gap-6">
						...
						<div class="relative">
							<div
								class="absolute -inset-1 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl opacity-20 blur"
							></div>
							<div
								class="relative bg-slate-800/80 backdrop-blur-xl border border-blue-500/30 rounded-2xl p-6"
							>
								<div class="mb-6">
									<h3 class="text-xl font-bold text-white mb-2">Monthly</h3>
									<div class="flex items-baseline gap-2">
										<span
											class="text-4xl font-bold bg-gradient-to-r from-blue-300 to-cyan-300 bg-clip-text text-transparent"
											>$199</span
										>
						...
						<div class="relative">
							<div
								class="absolute -inset-1 bg-gradient-to-r from-cyan-500 to-teal-500 rounded-2xl opacity-25 blur"
							></div>
							<div
								class="relative bg-slate-800/80 backdrop-blur-xl border border-cyan-500/30 rounded-2xl p-6"
							>
								<div
									class="absolute -top-3 -right-3 px-3 py-1 bg-gradient-to-r from-blue-500 to-cyan-500 text-white text-xs font-bold rounded-full"
								>
									Save 8%
								</div>
								...
								<div class="mb-6">
									...
									<div class="flex items-baseline gap-2">
										<span
											class="text-4xl font-bold bg-gradient-to-r from-cyan-300 to-teal-300 bg-clip-text text-transparent"
											>$549</span
										>
						...
						<div class="relative">
							<div
								class="absolute -inset-1 bg-gradient-to-r from-teal-500 to-emerald-500 rounded-2xl opacity-30 blur"
							></div>
							<div
							...
							>
								...
								<div class="mb-6">
									...
									<div class="flex items-baseline gap-2">
										<span
											class="text-4xl font-bold bg-gradient-to-r from-teal-300 to-emerald-300 bg-clip-text text-transparent"
											>$1,999</span
										>
