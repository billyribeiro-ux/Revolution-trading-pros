/**
 * Admin Member Analytics — revenue
...
export const GET: RequestHandler = async (event) => {
	...
	try {
		...
		const response = await fetch(`${API_URL}/api/admin/members/analytics/revenue${qs}`, {
			method: 'GET',
			headers: {
		...
		console.error('[API Proxy] members/analytics/revenue error:', err);
