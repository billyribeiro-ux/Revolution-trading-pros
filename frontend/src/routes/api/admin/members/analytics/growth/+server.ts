...
export const GET: RequestHandler = async (event) => {
	...
	try {
		...
		const response = await fetch(`${API_URL}/api/admin/members/analytics/growth${qs}`, {
			method: 'GET',
			headers: {
		...
		console.error('[API Proxy] members/analytics/growth error:', err);
