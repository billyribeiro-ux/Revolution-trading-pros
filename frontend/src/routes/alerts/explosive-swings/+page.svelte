...
>
    <section class="relative min-h-[90vh] flex items-center overflow-hidden py-20 lg:py-0">
        ...
        >
            <div class="text-center lg:text-left">
                ...
                >
                    Stop staring at the 1-minute chart. Get high-precision <strong>multi-day swing alerts</strong> backed by Dark Pool data. Designed for traders who want financial freedom, not another 9-to-5 job.
                </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p use:reveal={{ delay: 100 }} class="text-xl text-slate-400 max-w-2xl mx-auto">
                    Most traders burn out trying to scalp 1-minute candles against high-frequency algorithms. We play the bigger timeframe where institutions move money.
                </p>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-16 md:text-center max-w-3xl mx-auto">
                ...
                <p class="text-slate-400 text-lg">
                    We don't guess. We track the flow of money. Institutional investors leave footprints called "Dark Pool Prints" and "Unusual Options Activity." We follow them.
                </p>
            </div>

             <div class="grid md:grid-cols-3 gap-10">
                <article use:reveal={{ delay: 0 }} class="group bg-slate-950 p-8 rounded-2xl border border-slate-800 hover:border-emerald-500/30 transition-colors">
                    <div
                    ...
                    <p class="text-slate-400 leading-relaxed">
                        Institutions trade billions off-exchange to hide their intent. We monitor these "Dark Pool" block trades to see where Smart Money is accumulating positions *before* the breakout happens.
                    </p>
                </article>

                <article use:reveal={{ delay: 100 }} class="group bg-slate-950 p-8 rounded-2xl border border-slate-800 hover:border-blue-500/30 transition-colors">
                    <div
                    ...
                    <p class="text-slate-400 leading-relaxed">
                        Data isn't enough; timing is everything. We layer technical analysis (Supply/Demand Zones, Key Moving Averages, and Volume Profiles) to pinpoint the exact moment momentum shifts.
                    </p>
                </article>

                <article use:reveal={{ delay: 200 }} class="group bg-slate-950 p-8 rounded-2xl border border-slate-800 hover:border-indigo-500/30 transition-colors">
                    <div
                    ...
                    <p class="text-slate-400 leading-relaxed">
                        We hate losing money. Every alert comes with a predefined "Hard Stop" level. We calculate position size so that even if a trade fails, it only scratches the paint, but when it hits, it pays for the month.
                    </p>
                </article>
            </div>
            
            <div use:reveal={{ delay: 300 }} class="mt-16 bg-slate-950 p-6 md:p-8 rounded-2xl border border-slate-700/50 flex flex-col md:flex-row items-center gap-6 justify-between">
                <div>
                    <h4 class="text-lg font-bold text-white mb-2">How You Receive Alerts</h4>
                    <p class="text-slate-400 text-sm">We ensure you never miss a signal. Notifications are instant and redundant.</p>
                </div>
                <div class="flex gap-4">
                    <div class="flex items-center gap-2 bg-slate-900 px-4 py-2 rounded-lg border border-slate-800">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-10 flex flex-col md:flex-row justify-between items-end gap-4">
                ...
                <div class="text-right hidden md:block">
                     <span class="text-xs font-mono text-emerald-500 bg-emerald-500/10 px-3 py-1 rounded border border-emerald-500/20">Live Database Updated: Today</span>
                </div>
            </div>
            ...
            <div class="bg-slate-900 rounded-2xl border border-slate-800 overflow-hidden shadow-xl">
                    ...
                    <tbody class="divide-y divide-slate-800 font-mono text-sm">
                        <tr class="hover:bg-white/5 transition-colors group">
                            <td class="p-4 md:p-5 font-bold text-white flex items-center gap-2">
                                NVDA 
                                <span class="hidden group-hover:inline text-[10px] text-slate-500 font-normal">NVIDIA Corp</span>
                            </td>
                            <td class="p-4 md:p-5 text-emerald-400 font-bold">CALLS (Long)</td>
                            <td class="p-4 md:p-5 text-slate-400">5 Days</td>
                            <td class="p-4 md:p-5 text-right text-emerald-400 font-bold bg-emerald-500/5">+125%</td>
             ...
             <p class="text-center text-xs text-slate-600 mt-4 italic">
                *Results are illustrative of alert performance. Past performance does not guarantee future results.
            </p>
        </div>
    </section>
    ...
    <section class="py-20 bg-slate-900 border-t border-slate-800">
        <div class="max-w-4xl mx-auto px-4 text-center">
            <h2 class="text-2xl md:text-3xl font-heading font-bold text-white mb-8">Who Needs This Service?</h2>
            <div class="grid md:grid-cols-2 gap-8 text-left">
                <div class="flex gap-4">
                     <div class="w-10 h-10 rounded-full bg-emerald-500/10 flex-shrink-0 flex items-center justify-center text-emerald-500 font-bold">1</div>
                     <div>
                        <h4 class="text-white font-bold mb-1">Professionals with Day Jobs</h4>
                        <p class="text-slate-400 text-sm leading-relaxed">You can't watch the screen from 9:30 to 4:00. You need a strategy that lets you enter trades on your lunch break or from your phone without panic.</p>
                     </div>
                </div>
                <div class="flex gap-4">
                     <div class="w-10 h-10 rounded-full bg-emerald-500/10 flex-shrink-0 flex items-center justify-center text-emerald-500 font-bold">2</div>
                     <div>
                        <h4 class="text-white font-bold mb-1">Small Account Builders</h4>
                        <p class="text-slate-400 text-sm leading-relaxed">You want to grow a $2k - $10k account aggressively but safely, avoiding the "PDT Rule" that restricts day traders.</p>
                     </div>
                </div>
                 <div class="flex gap-4">
                     <div class="w-10 h-10 rounded-full bg-emerald-500/10 flex-shrink-0 flex items-center justify-center text-emerald-500 font-bold">3</div>
                     <div>
                        <h4 class="text-white font-bold mb-1">Failed Day Traders</h4>
                        <p class="text-slate-400 text-sm leading-relaxed">You've tried scalping and lost money to churn and fees. You're ready for a calmer, more statistical approach to the markets.</p>
                     </div>
                </div>
                 <div class="flex gap-4">
                     <div class="w-10 h-10 rounded-full bg-emerald-500/10 flex-shrink-0 flex items-center justify-center text-emerald-500 font-bold">4</div>
                     <div>
                        <h4 class="text-white font-bold mb-1">Options Buyers</h4>
                        <p class="text-slate-400 text-sm leading-relaxed">You understand the power of leverage. You want to turn a 5% stock move into a 50% option gain using safe, defined-risk structures.</p>
                     </div>
                </div>
            </div>
        </div>
    ...
    <section id="pricing" class="py-24 bg-slate-900 border-t border-slate-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-center mb-16">
                <div class="bg-rtp-surface bg-slate-950 p-1.5 rounded-xl border border-slate-700/50 inline-flex relative">
                    <button
                        type="button"
            ...
            <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
                <div
                    class="bg-slate-900 p-8 rounded-2xl border transition-all {selectedPlan === 'monthly' ? 'border-emerald-500 opacity-100 scale-105 shadow-xl shadow-emerald-500/10' : 'border-slate-800 opacity-70 hover:opacity-90'}"
                >
                    ...
                    <ul class="space-y-4 mb-8 text-sm text-slate-400">
                        ...
                        <li class="flex gap-3"><span class="text-emerald-500">✓</span> Instant SMS & Email Alerts</li>
                ...
                <div
                    class="bg-slate-950 p-10 rounded-3xl border-2 shadow-2xl transform relative z-10 transition-all {selectedPlan === 'quarterly' ? 'border-emerald-500 shadow-emerald-500/20 md:scale-110 opacity-100' : 'border-slate-800 shadow-slate-800/10 md:scale-100 opacity-70 hover:opacity-90'}"
                >
                    <div
                ...
                <div
                    class="bg-slate-900 p-8 rounded-2xl border transition-all {selectedPlan === 'annual' ? 'border-emerald-500 opacity-100 scale-105' : 'border-slate-800 opacity-70 hover:opacity-90'}"
                >
    ...
    <section class="py-20 bg-slate-950">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p class="text-slate-500 text-center mb-12">Everything you need to know about the service, capital requirements, and strategy.</p>
            ...
            <div class="text-center mt-12">
                 ...
                 <a href="/contact" class="text-emerald-500 hover:text-emerald-400 font-bold mt-2 inline-block border-b border-emerald-500/30 pb-0.5">Contact Our Support Team</a>
            </div>
        </div>
    </section>
    ...
    >
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p class="text-xl text-emerald-100 mb-10 max-w-2xl mx-auto">
                Join the trading room that values your time as much as your capital. Instant alerts, verified results, and a community of winners.
            </p>
            <a
                href="#pricing"
