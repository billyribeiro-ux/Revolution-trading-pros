...
<main
	class="spx-profit-pulse-page w-full overflow-x-hidden bg-slate-950 text-slate-200 font-sans selection:bg-indigo-500/30 selection:text-indigo-200"
>
			...
			<div class="grid md:grid-cols-4 gap-8 mb-12">
				...
				<div>
					...
					<ul class="space-y-2 text-sm text-slate-400">
						<li><a href="/login" class="hover:text-indigo-500">Member Login</a></li>
						<li><a href="#pricing" class="hover:text-indigo-500">Pricing</a></li>
						<li><a href="/performance" class="hover:text-indigo-500">Track Record</a></li>
					</ul>
				</div>
				<div>
					<h4 class="font-bold text-white mb-4">Legal</h4>
					<ul class="space-y-2 text-sm text-slate-400">
						<li><a href="/terms" class="hover:text-indigo-500">Terms of Service</a></li>
						<li><a href="/privacy" class="hover:text-indigo-500">Privacy Policy</a></li>
					</ul>
				</div>
			</div>
			<div
				class="border-t border-slate-800 pt-8 text-xs text-slate-400/60 leading-relaxed text-justify"
			>
