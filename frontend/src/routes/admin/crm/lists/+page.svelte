...
<svelte:head>
	<title>Contact Lists - FluentCRM Pro</title>
</svelte:head>
...
<div class="lists-page">
	...
	<div class="page-header">
		<div>
			<h1>Contact Lists</h1>
			<p class="page-description">Organize contacts into lists for targeted campaigns</p>
		</div>
	...
	<div class="stats-grid">
		...
		<div class="stat-card">
			...
			<div class="stat-content">
				...
				<span class="stat-label">Public Lists</span>
			</div>
		</div>
		<div class="stat-card">
			...
			<div class="stat-content">
				...
				<span class="stat-label">Private Lists</span>
			</div>
		</div>
		<div class="stat-card">
				...
				<tbody>
					{#each filteredLists as list}
						<tr>
							...
							<td>{formatNumber(list.contacts_count)}</td>
