...
<script lang="ts">
	...
	async function duplicateCampaign(id: string) {
		try {
			await crmAPI.duplicateRecurringCampaign(id);
			await loadCampaigns();
		} catch (err) {
...
<svelte:head>
	<title>Recurring Campaigns - FluentCRM Pro</title>
</svelte:head>
...
<div class="campaigns-page">
	...
	<div class="page-header">
		<div>
			...
			<p class="page-description">Schedule automated recurring newsletters and campaigns</p>
		</div>
				...
				<tbody>
					{#each filteredCampaigns as campaign}
						<tr>
								...
								<div class="campaign-cell">
									...
									<div class="campaign-info">
										...
										<span class="campaign-meta">
											{campaign.total_campaigns_sent} campaigns sent
										</span>
									</div>
								</div>
							</td>
							...
							<td>
								{#if campaign.scheduling_settings}
									{campaign.scheduling_settings.type}
									{campaign.scheduling_settings.time}
								{:else}
									Not scheduled
								{/if}
							</td>
							<td>{formatDate(campaign.last_sent_at)}</td>
							<td>{formatDate(campaign.next_scheduled_at)}</td>
