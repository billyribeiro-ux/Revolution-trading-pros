...
<svelte:head>
	<title>Add New Manager — Coming Soon | Admin</title>
</svelte:head>

<div class="stub-page">
	<header class="page-header">
		<a href="/admin/crm/managers" class="back-link">
			<IconArrowLeft size={18} />
			<span>Back to Managers</span>
		</a>
		<h1>Add New Manager</h1>
		<p class="page-description">Assign a manager to a CRM workspace.</p>
	</header>
	...
	<section class="stub-card">
		...
		<a href="/admin/crm/managers" class="btn-back">Return to Managers</a>
	</section>
</div>
