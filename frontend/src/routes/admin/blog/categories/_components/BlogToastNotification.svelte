<script lang="ts">
	/**
	 * R27-E extraction (2026-05-20): toast notification banner used at
	 * the top-right of the blog categories/tags page. Parent owns the
	 * `setTimeout` auto-dismiss; this component is presentation +
	 * close-click only.
	 */
