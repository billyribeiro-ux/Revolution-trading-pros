			...
			<div class="flex items-center gap-4">
				...
				<div class="flex items-center gap-3">
					<div class="p-2 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg">
						<Icon icon={IconUpload} class="w-6 h-6 text-indigo-600 dark:text-indigo-400" />
					</div>
					<div>
			...
			>
				...
				{#if importJob.status === 'completed'}
					<div class="text-center py-8">
						...
						>
							<Icon icon={IconCheck} class="w-8 h-8 text-green-600" />
						</div>
				...
				{#if importJob.status === 'failed'}
					<div class="text-center py-8">
						...
						>
							<Icon icon={IconX} class="w-8 h-8 text-red-600" />
						</div>
		...
		{:else if selectedSource}
			...
			>
				...
				>
					{#if file}
						<div class="flex items-center justify-center gap-3 mb-4">
							<Icon icon={IconFileSpreadsheet} class="w-10 h-10 text-indigo-600" />
							<div class="text-left">
					...
					{:else}
						<Icon icon={IconUpload} class="w-10 h-10 text-gray-400 mx-auto mb-4" />
				...
				{#if error}
					...
					>
						<Icon icon={IconAlertCircle} class="w-5 h-5 text-red-600" />
				...
				<div class="mt-6 flex justify-end">
					...
					>
						{#if loading}
							<Icon icon={IconLoader} class="w-4 h-4 animate-spin" />
							Importing...
						{:else}
