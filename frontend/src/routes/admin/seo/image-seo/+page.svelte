	...
	{:else}
		<div class="settings-section">
			<div class="settings-card">
				...
				<div class="setting-row">
					<label class="checkbox-label">
						<input type="checkbox" bind:checked={settings.altTextEnabled} />
				...
				<div class="setting-row">
					<label class="checkbox-label">
						<input type="checkbox" bind:checked={settings.altTextStripNumbers} />
						Remove numbers from filename
					</label>
				</div>
				<div class="setting-row">
					<label class="checkbox-label">
						<input type="checkbox" bind:checked={settings.altTextStripSpecialChars} />
			...
			<div class="settings-card">
				...
				<div class="setting-row">
					<label class="checkbox-label">
						<input type="checkbox" bind:checked={settings.titleEnabled} />
			...
			<div class="settings-card">
				...
				<div class="setting-row">
					<label class="checkbox-label">
						<input type="checkbox" bind:checked={settings.overwriteExisting} />
