<script lang="ts">
	...
	// FIX-2026-04-26: Tabler icons replace 8 raw inline <svg> blocks.
			...
			{#if connectedCount === 0}
				<div class="alert-banner alert-warning" in:fade={{ duration: 300 }}>
					<div class="alert-icon warning">
						<Icon name="IconAlertTriangle" size="md" label="Warning" />
					</div>
					<div class="flex-1">
					...
					<div class="metric-widget-inner">
						<div class="flex items-center justify-between mb-4">
							<div class="metric-icon emerald">
								<Icon name="IconCurrencyDollar" size="lg" label="Revenue" />
							</div>
							{#if !connections.stripe}
								<span class="metric-badge disconnected">Not Connected</span>
							{/if}
					...
					<div class="metric-widget-inner">
						<div class="flex items-center justify-between mb-4">
							<div class="metric-icon blue">
								<Icon name="IconSearch" size="lg" label="SEO Score" />
							</div>
					...
					<div class="metric-widget-inner">
						<div class="flex items-center justify-between mb-4">
							<div class="metric-icon amber">
								<Icon name="IconTrendingUp" size="lg" label="Monthly Recurring Revenue" />
							</div>
							{#if !connections.stripe}
								<span class="metric-badge disconnected">Not Connected</span>
							{/if}
				...
				<div class="section-card" in:fly={{ y: 30, duration: 400, delay: 350, easing: quintOut }}>
					...
					<div class="space-y-4">
						...
						<div class="integration-row">
							<div class="flex items-center gap-3">
								<div class="integration-icon emerald">
																		<!-- FIX-2026-04-26: replaced raw SVG with Tabler icon. Old: server -->
						...
						<div class="integration-row">
							<div class="flex items-center gap-3">
								<div class="integration-icon emerald">
																		<!-- FIX-2026-04-26: replaced raw SVG with Tabler icon. Old: database -->
						...
						<div class="integration-row">
							<div class="flex items-center gap-3">
								<div class="integration-icon emerald">
																		<!-- FIX-2026-04-26: replaced raw SVG with Tabler icon. Old: bolt -->
			...
			>
				<a href="/admin/settings" class="quick-action-card purple">
					<div class="quick-action-icon purple">
												<!-- FIX-2026-04-26: replaced raw SVG with Tabler icon. Old: settings/cog -->
				...
				<a href="/admin/analytics" class="quick-action-card blue">
					<div class="quick-action-icon blue">
												<!-- FIX-2026-04-26: replaced raw SVG with Tabler icon. Old: chart-bar -->
