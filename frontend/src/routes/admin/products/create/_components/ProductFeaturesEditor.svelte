<script lang="ts">
	/**
	 * R24-C extraction (2026-05-20): features list with add / remove. Discrete
	 * callbacks (R8-C style): `onAdd`, `onUpdate(index, value)`, `onRemove(index)`.
	...
	let { features, onAdd, onUpdate, onRemove }: Props = $props();
</script>
