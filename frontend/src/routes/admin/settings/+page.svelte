			...
			<div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
				...
				<div class="flex bg-white/5 backdrop-blur-xl rounded-2xl p-1 border border-white/10">
					<button
						...
						class="px-6 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 {activeTab === 'integrations'
					...
					<button
						...
						class="px-6 py-2.5 rounded-xl text-sm font-medium transition-all duration-300 {activeTab === 'general'
							? 'bg-white text-slate-900 shadow-lg'
							: 'text-slate-400 hover:text-white'}"
					>
						General Settings
