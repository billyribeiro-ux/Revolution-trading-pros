	...
	<div class="admin-page-container">
		...
		<section class="stats-section" in:fly={{ y: 30, duration: 600, delay: 100 }}>
			<div class="stats-grid">
				{#each [{ href: '/admin/cms/versions', icon: IconHistory, value: stats.versions.total, label: 'Content Versions', sublabel: `+${stats.versions.today || 0} today`, gradient: 'indigo', delay: 0 }, { href: '/admin/cms/workflows', icon: IconActivity, value: stats.workflows.pending, label: 'Pending Reviews', sublabel: `${stats.workflows.approved_today || 0} approved today`, gradient: 'amber', delay: 50 }, { href: '/admin/cms/webhooks', icon: IconWebhook, value: stats.webhooks.active, label: 'Active Webhooks', sublabel: `${stats.webhooks.success_rate}% success rate`, gradient: 'violet', delay: 100 }, { href: '/admin/cms/scheduled', icon: IconCalendarEvent, value: stats.scheduling.upcoming, label: 'Scheduled', sublabel: `${stats.scheduling.published_today || 0} published today`, gradient: 'cyan', delay: 150 }, { href: '/admin/cms/previews', icon: IconEye, value: stats.previews.active, label: 'Preview Links', sublabel: `${stats.previews.views_today || 0} views today`, gradient: 'rose', delay: 200 }, { href: '/admin/cms/locales', icon: IconWorld, value: stats.localization.active_locales, label: 'Languages', sublabel: `${stats.localization.total_translations} translations`, gradient: 'emerald', delay: 250 }] as item}
		...
		<section class="actions-section" in:fly={{ y: 30, duration: 600, delay: 400 }}>
			...
			<div class="actions-grid">
				{#each [{ href: '/admin/cms/versions', icon: IconHistory, label: 'Version History', desc: 'Browse & rollback versions', color: 'indigo' }, { href: '/admin/cms/workflows', icon: IconActivity, label: 'Workflow Manager', desc: 'Manage approval workflows', color: 'amber' }, { href: '/admin/cms/webhooks', icon: IconSend, label: 'Webhooks', desc: 'Configure integrations', color: 'violet' }, { href: '/admin/cms/scheduled', icon: IconCalendar, label: 'Scheduler', desc: 'Schedule publications', color: 'cyan' }, { href: '/admin/cms/locales', icon: IconLanguage, label: 'Localization', desc: 'Manage translations', color: 'emerald' }, { href: '/admin/cms/audit', icon: IconShield, label: 'Audit Logs', desc: 'View activity history', color: 'slate' }] as action, i}
...
<style>
	...
	.hero-title {
		...
		background: linear-gradient(135deg, #1a1a2e 0%, #4a4a6a 50%, var(--primary-500) 100%);
	...
	@media (max-width: calc(var(--breakpoint-lg) - 124px)) {
		.stats-grid {
			grid-template-columns: repeat(2, 1fr);
		}
	}

	@media (max-width: calc(var(--breakpoint-sm) - 40px)) {
		.stats-grid {
	...
	/* Gradient variations */
	.gradient-indigo .stat-icon-wrap {
	...
	.gradient-indigo .stat-card-glow {
		background: radial-gradient(circle, rgba(230, 184, 0, 0.1) 0%, transparent 70%);
	}

	.gradient-amber .stat-icon-wrap {
		background: linear-gradient(135deg, rgba(245, 158, 11, 0.12) 0%, rgba(245, 158, 11, 0.06) 100%);
		color: #d97706;
	}
	.gradient-amber:hover {
		border-color: rgba(245, 158, 11, 0.3);
	}
	.gradient-amber .stat-card-glow {
		background: radial-gradient(circle, rgba(245, 158, 11, 0.1) 0%, transparent 70%);
	}

	.gradient-violet .stat-icon-wrap {
		background: linear-gradient(135deg, rgba(230, 184, 0, 0.12) 0%, rgba(230, 184, 0, 0.06) 100%);
	...
	.gradient-violet .stat-card-glow {
		background: radial-gradient(circle, rgba(230, 184, 0, 0.1) 0%, transparent 70%);
	}

	.gradient-cyan .stat-icon-wrap {
	...
	.gradient-cyan .stat-card-glow {
		background: radial-gradient(circle, rgba(6, 182, 212, 0.1) 0%, transparent 70%);
	}

	.gradient-rose .stat-icon-wrap {
	...
	.gradient-rose .stat-card-glow {
		background: radial-gradient(circle, rgba(244, 63, 94, 0.1) 0%, transparent 70%);
	}

	.gradient-emerald .stat-icon-wrap {
	...
	.gradient-emerald .stat-card-glow {
