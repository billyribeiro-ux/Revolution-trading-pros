...
async function enableTracking(): Promise<void> {
	...
	try {
		...
		logger.error('[BehaviorIntegration] Failed to enable tracking', { error });
	}
}
...
function disableTracking(): void {
	...
	try {
		...
		logger.error('[BehaviorIntegration] Failed to disable tracking', { error });
	}
}
...
export function trackBehaviorEvent(
	...
	try {
		...
		logger.error('[BehaviorIntegration] Failed to track event', { error });
	}
}
...
export async function flushBehaviorEvents(): Promise<void> {
	...
	try {
		...
		logger.error('[BehaviorIntegration] Failed to flush events', { error });
	}
}
