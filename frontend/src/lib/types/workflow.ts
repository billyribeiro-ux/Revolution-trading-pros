export type NodeType = 'trigger' | 'condition' | 'action' | 'delay' | 'branch' | 'parallel' | 'merge' | 'end';
...
export interface TriggerTemplate {
  ...
  description: string;
  icon: string;
  category: 'contact' | 'form' | 'email' | 'funnel' | 'popup' | 'behavior' | 'crm' | 'subscription' | 'ecommerce' | 'trading' | 'system';
  config: Record<string, any>;
}
...
export interface ActionTemplate {
  ...
  description: string;
  icon: string;
  category: 'contact' | 'email' | 'crm' | 'notification' | 'funnel' | 'popup' | 'subscription' | 'integration' | 'flow' | 'ai';
  config: Record<string, any>;
