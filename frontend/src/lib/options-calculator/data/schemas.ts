...
export const polygonOptionsChainSchema = z.object({
...
export const polygonTickerSearchSchema = z.object({
	results: z.array(z.object({
		ticker: z.string(),
		name: z.string(),
		market: z.string(),
...
export const tradierOptionsChainSchema = z.object({
	options: z.object({
...
export const tradierExpirationsSchema = z.object({
