...
>
	...
	<div class="flex items-center gap-0.5">
		<button
			...
			style="color: var(--calc-text-muted);"><IconMinus size={10} /></button
		>
		<input
			type="number"
			value={leg.strike}
		...
		<button
			onclick={() => updateStrike(1)}
			class="w-5 h-5 flex items-center justify-center rounded text-xs cursor-pointer"
			style="color: var(--calc-text-muted);"><IconPlus size={10} /></button
		>
	</div>
	...
	<div class="flex items-center gap-0.5">
		<button
			...
			style="color: var(--calc-text-muted);"><IconMinus size={8} /></button
		>
		<span
		...
		<button
			onclick={() => updateQuantity(1)}
			class="w-4 h-4 flex items-center justify-center rounded text-xs cursor-pointer"
			style="color: var(--calc-text-muted);"><IconPlus size={8} /></button
		>
	</div>
