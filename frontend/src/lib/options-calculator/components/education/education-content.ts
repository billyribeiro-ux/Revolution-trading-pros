...
export const GREEK_EDUCATION: Record<string, EducationEntry> = {
	...
	vega: {
		...
		whenIncreases: 'Option is more sensitive to vol changes. Bigger swings from IV expansion/crush.',
...
export const INPUT_EDUCATION: Record<string, EducationEntry> = {
	...
	volatility: {
		...
		symbol: '\u03c3',
		shortDescription: "The market's expectation of future price movement, expressed as annualized percentage.",
		fullExplanation:
...
export const STRATEGY_EDUCATION: Record<string, EducationEntry> = {
	...
	'iron-condor': {
		id: 'iron-condor',
		term: 'Iron Condor',
		shortDescription: 'Sell OTM call spread + OTM put spread \u2014 profit from range-bound movement.',
		fullExplanation:
	...
	'bull-call-spread': {
		...
		shortDescription: 'Buy a lower-strike call + sell a higher-strike call \u2014 bullish with capped risk.',
		fullExplanation:
...
export const CONCEPT_EDUCATION: Record<string, EducationEntry> = {
	...
	'put-call-parity': {
		...
		shortDescription: 'The relationship that must hold between call and put prices to prevent arbitrage.',
		fullExplanation:
	...
	'expected-move': {
		id: 'expected-move',
		term: 'Expected Move',
		shortDescription: "The market's predicted price range for a stock by expiration (1 standard deviation).",
		fullExplanation:
	...
	moneyness: {
		id: 'moneyness',
		term: 'Moneyness',
		shortDescription: 'Whether an option has intrinsic value (ITM), is at the strike (ATM), or has no intrinsic value (OTM).',
		fullExplanation:
