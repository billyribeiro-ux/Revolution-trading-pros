<script lang="ts">
	import type { FormField, NewsletterFieldOptions } from '$lib/api/forms';
			...
			<div class="newsletter-subscribe-wrapper">
				<label class="newsletter-checkbox-label">
					...
					<span class="newsletter-checkbox-text">
						{(field.options as NewsletterFieldOptions)?.checkbox_label ||
							'Yes, I want to receive newsletters'}
					</span>
				</label>
				{#if (field.options as NewsletterFieldOptions)?.show_privacy_link !== false}
					<a
						href={(field.options as NewsletterFieldOptions)?.privacy_url || '/privacy-policy'}
						target="_blank"
