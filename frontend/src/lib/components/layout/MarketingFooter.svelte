<script lang="ts">
	/**
	 * MarketingFooter - Footer for marketing/public pages
	 * 
	 * @version 2.0.0
	...
	const footerLinks = {
		products: [
			...
			{ href: '/alerts', label: 'SPX Profit Pulse' },
			{ href: '/indicators', label: 'Trading Indicators' },
...
<style>
	/* 
	 * MarketingFooter - Svelte 5 Component Styles
	 * Following Svelte 5 best practices with scoped CSS
	 * Root cause fix: Removed conflicting @tailwindcss/postcss package
	 */
