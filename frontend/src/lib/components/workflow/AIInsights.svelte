      ...
      {#if activeTab === 'predictions'}
        <div class="prediction-card">
          <div class="metric">
            ...
            <span class="value success">{Math.round(insights.predictions.predicted_success * 100)}%</span>
          </div>
          <div class="metric">
            <span class="label">Estimated Duration</span>
            <span class="value">{(insights.predictions.estimated_duration_ms / 1000).toFixed(1)}s</span>
          </div>
          <div class="metric">
            ...
            <div class="suggestion-card">
              <div class="suggestion-header">
                <span
                  ...
                  style="background: {getPriorityColor(suggestion.priority)}20; color: {getPriorityColor(suggestion.priority)};"
                >
                  {suggestion.priority}
                </span>
