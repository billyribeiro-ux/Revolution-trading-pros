...
<div class="workflow-analytics">
  <div class="analytics-header">
    ...
    <div class="time-range-selector">
      ...
      <button class:active={timeRange === '30d'} on:click={() => timeRange = '30d'}>30 Days</button>
      <button class:active={timeRange === '90d'} on:click={() => timeRange = '90d'}>90 Days</button>
    </div>
  </div>
    ...
    <div class="charts-section">
      <div class="chart-card">
        ...
        <div class="line-chart">
          {#each analytics.runs_by_day as day, i}
