			...
			<div class="time-units">
				{#if showDays && (timeData.days > 0 || !compactMode)}
					<div class="time-unit" class:flip={digitFlips.days}>
						<div class="time-value">{leadingZeros ? timeData.days.toString().padStart(2, '0') : timeData.days}</div>
						{#if showLabels}
				...
				{#if showHours && (timeData.hours > 0 || !compactMode)}
					...
					<div class="time-unit" class:flip={digitFlips.hours}>
						<div class="time-value">{leadingZeros ? timeData.hours.toString().padStart(2, '0') : timeData.hours}</div>
						{#if showLabels}
				...
				{#if showMinutes && (timeData.minutes > 0 || !compactMode)}
					...
					<div class="time-unit" class:flip={digitFlips.minutes}>
						<div class="time-value">{leadingZeros ? timeData.minutes.toString().padStart(2, '0') : timeData.minutes}</div>
						{#if showLabels}
				...
				{#if showSeconds}
					{#if showSeparators && (showDays || showHours || showMinutes)}<span class="separator">:</span>{/if}
					<div class="time-unit" class:flip={digitFlips.seconds}>
						<div class="time-value">{leadingZeros ? timeData.seconds.toString().padStart(2, '0') : timeData.seconds}</div>
						{#if showLabels}
