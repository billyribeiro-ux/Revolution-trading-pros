						...
						{#each group.files.slice(0, 4) as file (file.id)}
							<div class="file-card">
								<div class="file-thumbnail">
									<img src="/storage/{file.path}" alt={file.filename} width="150" height="150" loading="lazy" decoding="async" />
								</div>
								<div class="file-info">
							...
							<label class="file-option" class:selected={selectedKeepId === file.id}>
								...
								<div class="file-option-content">
									<div class="file-option-thumbnail">
										<img src="/storage/{file.path}" alt={file.filename} width="80" height="80" loading="lazy" decoding="async" />
									</div>
