            ...
            <div class="preview-sidebar">
              ...
              <div class="info-section">
                ...
                <div class="status-row">
                  <span class="status-badge" class:optimized={item.is_optimized} class:pending={!item.is_optimized}>
              ...
              <div class="info-section">
                ...
                {#if isEditing}
                  <div class="edit-form">
                    <label>
                      <span>Alt Text</span>
                      <input type="text" bind:value={editData.alt_text} placeholder="Describe the image..." />
                    </label>
                    <label>
                      <span>Title</span>
