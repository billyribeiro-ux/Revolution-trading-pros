    ...
    switch (widgetConfig.widget_type) {
      ...
      case 'revenue_mrr':
        configFields = [
          ...
          { key: 'format', type: 'select', label: 'Number Format', value: 'full', options: ['compact', 'full'] },
      ...
      case 'user_growth':
        configFields = [
          ...
          { key: 'show_growth', type: 'boolean', label: 'Show Growth', value: true },
          { key: 'highlight_threshold', type: 'number', label: 'Highlight Threshold (%)', value: 20 },
          { key: 'format', type: 'select', label: 'Number Format', value: 'full', options: ['compact', 'full'] },
        ];
        break;
...
<div class="widget-builder">
  ...
  <div class="builder-form">
    ...
    <div class="form-actions">
      <button class="btn-secondary" on:click={handlePreview}>
        Preview Widget
      </button>
