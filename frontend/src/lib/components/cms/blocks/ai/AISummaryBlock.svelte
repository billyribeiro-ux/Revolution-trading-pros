...
<script lang="ts">
	...
	import { Icon, IconChevronDown, IconLoader2, IconRefresh, IconSparkles } from '$lib/icons';
...
<style>
	...
	:global(.dark) .ai-summary-block {
		background: linear-gradient(135deg, #1e1b4b 0%, #312e81 100%);
		border-color: #4c1d95;
	}
	:global(.dark) .header-left {
		color: #c4b5fd;
	}
	:global(.dark) .chevron {
		color: #c4b5fd;
	...
	:global(.dark) .source-section textarea {
		background: #0f172a;
		border-color: #4c1d95;
		color: #e2e8f0;
	}
	:global(.dark) .length-select {
		color: #c4b5fd;
	}
	:global(.dark) .length-select select {
		background: #0f172a;
		border-color: #4c1d95;
		color: #e2e8f0;
	}
	:global(.dark) .output-header span {
		color: #c4b5fd;
	}
	:global(.dark) .regen-btn {
		background: #312e81;
		color: #c4b5fd;
	}
