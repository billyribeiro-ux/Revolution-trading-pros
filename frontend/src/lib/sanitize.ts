 ...
 *
 * Prefer importing from `#lib/utils/sanitize.js` for new code; this barrel is
 * provided so that existing `#lib/sanitize.js` imports keep working and remain
...
export type { SanitizeProfile } from '#lib/utils/sanitize.js';
