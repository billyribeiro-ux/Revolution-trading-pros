...
import IconBuildingSkyscraper from '@tabler/icons-svelte/icons/building-skyscraper';
...
// Brand Icons
import IconBrandAsana from '@tabler/icons-svelte/icons/brand-asana';
import IconBrandBing from '@tabler/icons-svelte/icons/brand-bing';
...
import IconCursor from '@tabler/icons-svelte/icons/click';
...
import IconMapPin2 from '@tabler/icons-svelte/icons/map-pin-2';
import IconMapPins from '@tabler/icons-svelte/icons/map-pins';
...
import IconSquareRoundedMinus from '@tabler/icons-svelte/icons/square-rounded-minus';
import IconSquareRoundedPlus from '@tabler/icons-svelte/icons/square-rounded-plus';
import IconSquareRoundedX from '@tabler/icons-svelte/icons/square-rounded-x';
import IconStack from '@tabler/icons-svelte/icons/stack';
...
import IconSubtask from '@tabler/icons-svelte/icons/subtask';
...
import IconTestPipe2 from '@tabler/icons-svelte/icons/test-pipe-2';
...
import IconTimeline from '@tabler/icons-svelte/icons/timeline';
