...
// Import icons individually from the icons subpath to avoid TypeScript barrel export issues
...
export {
	...
	IconBook,
	IconDeviceFloppy,
	IconDeviceFloppy as IconSave, // Alias for backwards compatibility
	IconShare,
	IconBookmark,
	// Geographic & Location
	IconMapPin,
