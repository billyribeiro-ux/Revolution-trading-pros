...
export const traders: Trader[] = [
	...
	},
	{
		...
		whoIs:
			'Henry Gambell is the Director of Options at Simpler Trading. He focuses on high-probability options setups using technical analysis and risk management principles. His methodical approach has helped countless traders improve their skills.',
		tradingApproach:
			"Henry's trading style emphasizes patience and discipline, waiting for the right setups before entering trades. He is known for his ability to break down complex concepts for traders of all levels.",
	...
	},
	{
		...
		whoIs:
			'Taylor Horton is a Senior Trader at Simpler Trading specializing in day trading and swing trading strategies. He focuses on momentum plays and breakout patterns that have proven successful over time.',
		tradingApproach:
			'Taylor brings energy and enthusiasm to his trading sessions, helping members identify actionable setups in real-time with a focus on risk management.',
	...
	},
	{
		...
		whoIs:
			'Bruce Marshall is a Senior Trader with expertise in options strategies and portfolio management. He focuses on income-generating strategies and risk-defined trades that work in various market conditions.',
		tradingApproach:
	...
	},
	{
		...
		whoIs:
			'Danielle Shay is the Director of Options at Simpler Trading. She specializes in momentum-based options strategies and volatility trading, helping traders navigate fast-moving markets.',
		tradingApproach:
	...
	},
	{
		...
		whoIs:
			'Allison Ostrander is the Director of Risk Tolerance at Simpler Trading. She specializes in helping traders with smaller accounts grow their portfolios responsibly without taking excessive risks.',
		tradingApproach:
			"Allison's approach emphasizes proper position sizing, risk management, and building a sustainable trading practice that can last for years.",
	...
	},
	{
		...
		whoIs:
			'Sam Shames is a Senior Trader specializing in futures and day trading. He focuses on ES and NQ futures with a momentum-based approach that has proven effective in various market conditions.',
		tradingApproach:
			'Sam is known for his quick analysis and ability to adapt to changing market conditions, helping traders stay ahead of the curve.',
	...
	},
	{
		...
		whoIs:
			'Kody Ashmore is a Senior Futures Trader at Simpler Trading. He specializes in ES and NQ futures with a focus on intraday momentum setups that capture quick, high-probability moves.',
		tradingApproach:
	...
	},
	{
		...
		whoIs:
			'Raghee Horner is a Senior Trader with over 30 years of trading experience. She specializes in forex and futures trading with a focus on technical analysis that has stood the test of time.',
		tradingApproach:
