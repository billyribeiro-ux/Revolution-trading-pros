...
class LicenseGenerationHandler
{
    ...
    public function register()
    {
        ...
        // fluent_cart/order_payment_failed -> revoke
        add_action('fluent_cart/order_payment_failed', [$this, 'maybeRevokeLicensesOnPaymentFailed'], 10, 1);
    ...
    public function maybeRevokeLicensesOnPaymentFailed($data)
    {
        $revokeLicenseOnPaymentFailed = apply_filters('fluent_cart/licensing/revoke_license_on_payment_failed', true, $data);

        if (!$revokeLicenseOnPaymentFailed) {
            return false;
        }
        ...
        foreach ($licenses as $license) {
            ...
            $prevConfig['reason'] = 'Payment Failed';
