...
<DropdownMenu.Root>
	...
	<DropdownMenu.Content class="w-56">
		...
		<DropdownMenu.Item class="text-red-600">Log out</DropdownMenu.Item>
...
<script>
	...
	const trades = [
		{ ticker: 'NVDA', entry: 142.5, exit: 156.0, profit: '+9.5%' },
		{ ticker: 'TSLA', entry: 248.0, exit: 265.0, profit: '+6.9%' }
	];
</script>
