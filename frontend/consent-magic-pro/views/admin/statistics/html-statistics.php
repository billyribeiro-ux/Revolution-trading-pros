...
?>
<div class="container">
    <form method="post" action="<?php echo esc_url( get_admin_url( null, 'admin.php?page=cs-proof-statistics' ) ); ?>"
        ...
        <div class="cs-tab-content">
			<?php
			include_once CMPRO_PLUGIN_VIEWS_PATH . "admin/statistics/cs-statistics.php";
			?>
        </div>
    </form>
</div>