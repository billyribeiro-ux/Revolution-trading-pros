...
$order_meta = edd_get_payment_meta( $order_id );

$data = array(
	"cs_type"                => isset( $order_meta[ '_cs_type' ] ) ? $order_meta[ '_cs_type' ] : '',
	"cs_expressed"           => isset( $order_meta[ '_cs_expressed' ] ) ? $order_meta[ '_cs_expressed' ] : '',
	"cs_category_yes"        => isset( $order_meta[ '_cs_category_yes' ] ) ? $order_meta[ '_cs_category_yes' ] : '',
	"cs_category_no"         => isset( $order_meta[ '_cs_category_no' ] ) ? $order_meta[ '_cs_category_no' ] : '',
	"cs_title"               => isset( $order_meta[ '_cs_title' ] ) ? $order_meta[ '_cs_title' ] : '',
	"cs_google_consent_mode" => array(
		'analytics_storage'  => isset( $order_meta[ '_cm_analytics_storage' ] ) ? $order_meta[ '_cm_analytics_storage' ] : '',
		'ad_storage'         => isset( $order_meta[ '_cm_ad_storage' ] ) ? $order_meta[ '_cm_ad_storage' ] : '',
		'ad_user_data'       => isset( $order_meta[ '_cm_ad_user_data' ] ) ? $order_meta[ '_cm_ad_user_data' ] : '',
		'ad_personalization' => isset( $order_meta[ '_cm_ad_personalization' ] ) ? $order_meta[ '_cm_ad_personalization' ] : '',
	),
);
...
if ( $data && is_array( $data ) ) :
    ...
    <table class="cs_order_meta">
        ...
        <tr>
            <th><?php esc_html_e( 'Rule\'s name:', "consent-magic" ); ?></th>
            <td><?php echo !empty( $data[ 'cs_title' ] ) ? esc_attr( $data[ 'cs_title' ] ) : "" ?></td>
        </tr>

        <tr>
            <th><?php esc_html_e( 'Consent expressed:', "consent-magic" ); ?></th>
		...
		<?php if ( ( ( !empty( $data[ 'cs_category_yes' ] ) || !empty( $data[ 'cs_category_no' ] ) ) || $data[ 'cs_type' ] == 'inform_and_opiout' ) ) {
            ...
            <tr>
                <th colspan="2"><?php esc_html_e( 'Consent by category:', "consent-magic" ); ?></th>
            </tr>
