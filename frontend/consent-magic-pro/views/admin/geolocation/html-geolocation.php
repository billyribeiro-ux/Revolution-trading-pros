...
<div class="container">
    <form method="post" action="<?php echo esc_url( get_admin_url( null, 'admin.php?page=cs-geolocation' ) ); ?>"
        ...
        <div class="cs-tab-content">
			<?php
			//save button
			include_once CMPRO_PLUGIN_VIEWS_PATH . "admin/geolocation/general-geolocation-html.php";
			?>
        </div>
    </form>
</div>
