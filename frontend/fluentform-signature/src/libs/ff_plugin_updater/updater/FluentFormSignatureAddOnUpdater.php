...
class FluentFormSignatureAddOnUpdater
{
    private $api_url = '';
...
//
    ...
    public function show_changelog()
    {
        ...
        if (!current_user_can('update_plugins')) {
            wp_die('You do not have permission to install plugin updates', 'Error',
                array('response' => 403));
        }
    ...
    {
        if (empty($expiration)) {
            $expiration = strtotime('+24 hours', current_time('timestamp'));
        }
