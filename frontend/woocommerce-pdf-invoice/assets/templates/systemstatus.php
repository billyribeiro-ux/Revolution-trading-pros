	...
	<thead>
		<tr>
			<th colspan="3" data-export-label="pdf-invoices"><h2><?php esc_html_e( 'WooCommerce PDF Invoices', 'woocommerce-pdf-invoice' ); ?>
				<?php echo esc_html( wc_help_tip( __( 'This section shows information about WooCommerce PDF Invoice settings.', 'woocommerce-pdf-invoice' ) ) ); ?>
			</h2></th>
		</tr>
	</thead>
	<tbody>
		...
		<tr>
			...
			<td class="help"><?php echo esc_html( wc_help_tip( $data['tip'] ) ); ?></td>
			<td>
