	...
	<table class="form-table">
	    ...
	    <tr valign="top">
	        <th scope="row" class="titledesc">
	            <label for="woocommerce_pdf_invoice_layout_settings[template_css]"><?php esc_html_e('Set the CSS for PDF template.', 'woocommerce-pdf-invoice' ); ?></label>
	        ...
	        <textarea name="woocommerce_pdf_invoice_layout_settings[template_css]" id="woocommerce_pdf_invoice_layout_settings[template_css]" style="width: 350px; height:200px;"><?php echo wp_kses_post( $woocommerce_pdf_invoice_layout_options['template_css'] ); ?></textarea>
	        </td>
	    </tr>
<?php
		// Product rows
...
?>
	...
	<p class="submit">
	<input type="submit" class="button-primary" value="<?php esc_html_e( 'Save Layout Options', 'woocommerce-pdf-invoice' ); ?>" />
	</p>
