...
<h3 class="dompdf-config"><?php esc_html_e("Columns For Order Details Section." , 'woocommerce-pdf-invoice' ); ?></h3>
                    
<form method="post" action="" >
<table class="dompgf-debugging-table">
	<tr>
    	<th><?php esc_html_e("Use" , 'woocommerce-pdf-invoice' ); ?></th>
      <th><?php esc_html_e("Field" , 'woocommerce-pdf-invoice' ); ?></th>
      <th><?php esc_html_e("Title" , 'woocommerce-pdf-invoice' ); ?></th>
      <th><?php esc_html_e("Width" , 'woocommerce-pdf-invoice' ); ?></th>
      <th><?php esc_html_e("Order" , 'woocommerce-pdf-invoice' ); ?></th>
  </tr>
  <tr>
