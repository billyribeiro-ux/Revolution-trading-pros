<?php
    ...
    class WC_send_pdf {
		...
		public static function get_woocommerce_pdf_invoice( $order = NULL, $email_id = NULL, $stream = NULL ) {
			...
			if( file_exists( $pdftemp . '/' . $filename )  && isset( $stream ) && $stream === FALSE ) {
			 ...
			 */
	  		if( isset( $settings["pdf_debug"] ) && $settings["pdf_debug"] == "true" ) {
	  			...
	  			WC_pdf_debug::pdf_debug( $messagetext, 'WC_PDF_Invoice_', __('PDF Invoice Body : ', 'woocommerce-pdf-invoice'), TRUE );
