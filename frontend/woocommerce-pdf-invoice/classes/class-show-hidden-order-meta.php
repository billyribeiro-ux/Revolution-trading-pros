...
if( !class_exists( 'PDF_Hidden_Order_Meta' ) ) {
	...
	?>
			<table>
				<thead>
					<tr>
						<th class="key-column"><?php esc_html_e( 'Key', 'woocommerce-pdf-invoice' ); ?></th>
						<th class="value-column"><?php esc_html_e( 'Value', 'woocommerce-pdf-invoice' ); ?></th>
					</tr>
				</thead>
				<tbody>
	<?php
	...
	?>
					<tr><th style="text-align:left"><?php echo esc_html( $key ); ?></th><td>
	<?php 
