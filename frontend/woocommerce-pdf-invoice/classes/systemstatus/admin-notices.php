		...
		function admin_notice() {
			...
			if( current_user_can( 'manage_woocommerce' ) ) {
				...
				if( empty( $show_notice ) || $show_notice != '1' ) {
					...
					echo '<div class="notice notice-warning pdf-invoices-missing-logo-notice is-dismissible"><h3>' . esc_html( $remote_logo_warning_heading ) . '</h3><h4>' . esc_html( $remote_logo_warning_body ) . '</h4></div>';
				}
