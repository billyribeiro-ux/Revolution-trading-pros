...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (!Schema::hasTable('form_collaborators')) {
        ...
        // Form comments table
        if (!Schema::hasTable('form_comments')) {
        ...
        // Form activity log
        if (!Schema::hasTable('form_activity_log')) {
        ...
        if (!Schema::hasTable('form_notification_logs')) {
        ...
        if (!Schema::hasTable('form_embed_analytics')) {
        ...
        // Form short URLs
        if (!Schema::hasTable('form_short_urls')) {
        ...
        if (!Schema::hasTable('form_search_analytics')) {
        ...
        // Related forms
        if (!Schema::hasTable('form_relations')) {
        ...
        // Add indexes for search optimization (MySQL only - SQLite doesn't support fulltext)
        if (Schema::hasColumn('forms', 'title') && config('database.default') === 'mysql') {
            Schema::table('forms', function (Blueprint $table) {
